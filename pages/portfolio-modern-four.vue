    ...
    <section class="relative md:py-24 py-16">
        <div class="container">
            ...
            <div id="grid" class="md:flex justify-center mx-auto mt-4">
                <div class="lg:w-1/4 md:w-1/2 p-4 picture-item" data-groups='["branding"]'>
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        ...
                        <div class="content transition-all duration-500">
                            <div
                                class="icon absolute z-10 hidden group-hover:block top-6 ltr:right-6 rtl:left-6 transition-all duration-500">
                                <a href="@/assets/images/portfolio/1.jpg"
                                    class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white btn-icon rounded-full lightbox"><i
                ...
                <div class="lg:w-1/4 md:w-1/2 p-4 picture-item" data-groups='["designing"]'>
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        ...
                        <div class="content transition-all duration-500">
                            ...
                            <div
                                class="absolute z-10 hidden group-hover:block bottom-6 ltr:left-6 rtl:right-6 transition-all duration-500">
                                <a href="portfolio-detail-three.html"
                                    class="h6 text-lg font-medium hover:text-indigo-600 duration-500 ease-in-out">Mockup
                                    Collection</a>
                                <p class="text-slate-400 mb-0">Abstract</p>
                ...
                <div class="lg:w-1/4 md:w-1/2 p-4 picture-item" data-groups='["photography"]'>
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                ...
                <div class="lg:w-1/4 md:w-1/2 p-4 picture-item" data-groups='["development"]'>
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                ...
                <div class="lg:w-1/4 md:w-1/2 p-4 picture-item" data-groups='["branding"]'>
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        <img src="@/assets/images/portfolio/23.jpg"
                            class="group-hover:origin-center group-hover:scale-110 group-hover:rotate-3 transition duration-500"
                            alt="">
                        <div
                            class="absolute inset-2 group-hover:bg-white/90 dark:group-hover:bg-slate-900/90 transition duration-500 z-0 rounded-md">
