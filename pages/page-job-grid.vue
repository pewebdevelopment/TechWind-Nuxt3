                ...
                <div class="grid grid-cols-1 pb-8 text-center mt-10">
                    ...
                    <ul class="breadcrumb tracking-[0.5px] breadcrumb-light mb-0 inline-block">
                       ...
                       <li class="inline breadcrumb-item uppercase text-[13px] font-bold duration-500 ease-in-out text-white/50 hover:text-white"><a href="index-job.html">Job</a></li>
                        <li class="inline breadcrumb-item uppercase text-[13px] font-bold duration-500 ease-in-out text-white" aria-current="page">All Jobs</li>
                    </ul>
                </div><!--end grid-->
            </div><!--end container-->
        </section><!--end section-->
        ...
        <section class="relative md:py-24 py-16">
            ...
            <div class="container">
                <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                    ...
                    <div class="rounded-md shadow dark:shadow-gray-800">
                        <div class="p-6">
                            <a href="page-job-detail.html" class="title h5 text-lg font-semibold hover:text-indigo-600">Web Developer</a>
                            <p class="text-slate-400 mt-2"><i class="uil uil-clock text-indigo-600"></i> Posted 3 Days ago</p>

                            <div class="flex justify-between items-center mt-4">
                                <span class="bg-indigo-600/5 text-indigo-600 text-xs font-bold px-2.5 py-0.5 rounded h-5">Remote</span>

                                <p class="text-slate-400"><i class="uil uil-usd-circle text-indigo-600"></i> $2500 - $2600/mo</p>
                            </div>
                        </div>

                        <div class="flex items-center p-6 border-t border-gray-100 dark:border-gray-700">
                            <img src="@/assets/images/client/google-logo.png" class="h-12 w-12 shadow-md dark:shadow-gray-800 rounded-md p-2 bg-white dark:bg-slate-900" alt="">
                    ...
                    <div class="rounded-md shadow dark:shadow-gray-800">
                        <div class="p-6">
                            <a href="page-job-detail.html" class="title h5 text-lg font-semibold hover:text-indigo-600">UX/UI Designer</a>
                            <p class="text-slate-400 mt-2"><i class="uil uil-clock text-indigo-600"></i> Posted 3 Days ago</p>

                            <div class="flex justify-between items-center mt-4">
                                <span class="bg-indigo-600/5 text-indigo-600 text-xs font-bold px-2.5 py-0.5 rounded h-5">Freelance</span>

                                <p class="text-slate-400"><i class="uil uil-usd-circle text-indigo-600"></i> $3500 - $3600/mo</p>
                            </div>
                        </div>

                        <div class="flex items-center p-6 border-t border-gray-100 dark:border-gray-700">
                            <img src="@/assets/images/client/linkedin.png" class="h-12 w-12 shadow-md dark:shadow-gray-800 rounded-md p-2 bg-white dark:bg-slate-900" alt="">
                    ...
                    <div class="rounded-md shadow dark:shadow-gray-800">
                        <div class="p-6">
                            <a href="page-job-detail.html" class="title h5 text-lg font-semibold hover:text-indigo-600">Human Resource(HR)</a>
                            <p class="text-slate-400 mt-2"><i class="uil uil-clock text-indigo-600"></i> Posted 3 Days ago</p>

                            <div class="flex justify-between items-center mt-4">
                                <span class="bg-indigo-600/5 text-indigo-600 text-xs font-bold px-2.5 py-0.5 rounded h-5">Part Time</span>

                                <p class="text-slate-400"><i class="uil uil-usd-circle text-indigo-600"></i> $2000 - $2500/mo</p>
                            </div>
                        </div>

                        <div class="flex items-center p-6 border-t border-gray-100 dark:border-gray-700">
                            <img src="@/assets/images/client/skype.png" class="h-12 w-12 shadow-md dark:shadow-gray-800 rounded-md p-2 bg-white dark:bg-slate-900" alt="">
                    ...
                    <div class="rounded-md shadow dark:shadow-gray-800">
                        <div class="p-6">
                            <a href="page-job-detail.html" class="title h5 text-lg font-semibold hover:text-indigo-600">Web Designer</a>
                            <p class="text-slate-400 mt-2"><i class="uil uil-clock text-indigo-600"></i> Posted 3 Days ago</p>

                            <div class="flex justify-between items-center mt-4">
                                <span class="bg-indigo-600/5 text-indigo-600 text-xs font-bold px-2.5 py-0.5 rounded h-5">Full Time</span>

                                <p class="text-slate-400"><i class="uil uil-usd-circle text-indigo-600"></i> $1500 - $1600/mo</p>
                            </div>
                        </div>

                        <div class="flex items-center p-6 border-t border-gray-100 dark:border-gray-700">
                            <img src="@/assets/images/client/spotify.png" class="h-12 w-12 shadow-md dark:shadow-gray-800 rounded-md p-2 bg-white dark:bg-slate-900" alt="">
                    ...
                    <div class="rounded-md shadow dark:shadow-gray-800">
                        <div class="p-6">
                            <a href="page-job-detail.html" class="title h5 text-lg font-semibold hover:text-indigo-600">Graphic Designer</a>
                            <p class="text-slate-400 mt-2"><i class="uil uil-clock text-indigo-600"></i> Posted 3 Days ago</p>
                        ...
                        <div class="flex items-center p-6 border-t border-gray-100 dark:border-gray-700">
                            <img src="@/assets/images/client/telegram.png" class="h-12 w-12 shadow-md dark:shadow-gray-800 rounded-md p-2 bg-white dark:bg-slate-900" alt="">
                    ...
                    <div class="rounded-md shadow dark:shadow-gray-800">
                        <div class="p-6">
                            <a href="page-job-detail.html" class="title h5 text-lg font-semibold hover:text-indigo-600">Senior Web Developer</a>
                            <p class="text-slate-400 mt-2"><i class="uil uil-clock text-indigo-600"></i> Posted 3 Days ago</p>
                        ...
                        <div class="flex items-center p-6 border-t border-gray-100 dark:border-gray-700">
                            <img src="@/assets/images/client/circle-logo.png" class="h-12 w-12 shadow-md dark:shadow-gray-800 rounded-md p-2 bg-white dark:bg-slate-900" alt="">

                            <div class="ltr:ml-3 rtl:mr-3">
                                <h6 class="mb-0 font-semibold text-base">Circle CI Ltd.</h6>
                                <span class="text-slate-400 text-sm">Australia</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-md shadow dark:shadow-gray-800">
                        <div class="p-6">
                            <a href="page-job-detail.html" class="title h5 text-lg font-semibold hover:text-indigo-600">Front-End Developer</a>
                            <p class="text-slate-400 mt-2"><i class="uil uil-clock text-indigo-600"></i> Posted 3 Days ago</p>
                        ...
                        <div class="flex items-center p-6 border-t border-gray-100 dark:border-gray-700">
                            <img src="@/assets/images/client/lenovo-logo.png" class="h-12 w-12 shadow-md dark:shadow-gray-800 rounded-md p-2 bg-white dark:bg-slate-900" alt="">

                            <div class="ltr:ml-3 rtl:mr-3">
                                <h6 class="mb-0 font-semibold text-base">Lenovo Ltd.</h6>
                                <span class="text-slate-400 text-sm">America</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-md shadow dark:shadow-gray-800">
                        <div class="p-6">
                            <a href="page-job-detail.html" class="title h5 text-lg font-semibold hover:text-indigo-600">Back-End Developer</a>
                            <p class="text-slate-400 mt-2"><i class="uil uil-clock text-indigo-600"></i> Posted 3 Days ago</p>
                        ...
                        <div class="flex items-center p-6 border-t border-gray-100 dark:border-gray-700">
                            <img src="@/assets/images/client/shree-logo.png" class="h-12 w-12 shadow-md dark:shadow-gray-800 rounded-md p-2 bg-white dark:bg-slate-900" alt="">

                            <div class="ltr:ml-3 rtl:mr-3">
                                <h6 class="mb-0 font-semibold text-base">Shreethemes Ltd.</h6>
                                <span class="text-slate-400 text-sm">Canada</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-md shadow dark:shadow-gray-800">
                        <div class="p-6">
                            <a href="page-job-detail.html" class="title h5 text-lg font-semibold hover:text-indigo-600">Data Entry</a>
                            <p class="text-slate-400 mt-2"><i class="uil uil-clock text-indigo-600"></i> Posted 3 Days ago</p>
                        ...
                        <div class="flex items-center p-6 border-t border-gray-100 dark:border-gray-700">
                            <img src="@/assets/images/client/snapchat.png" class="h-12 w-12 shadow-md dark:shadow-gray-800 rounded-md p-2 bg-white dark:bg-slate-900" alt="">

                            <div class="ltr:ml-3 rtl:mr-3">
                                <h6 class="mb-0 font-semibold text-base">Snapchat Ltd.</h6>
                                <span class="text-slate-400 text-sm">UK</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-md shadow dark:shadow-gray-800">
                        <div class="p-6">
                            <a href="page-job-detail.html" class="title h5 text-lg font-semibold hover:text-indigo-600">Android Developer</a>
                            <p class="text-slate-400 mt-2"><i class="uil uil-clock text-indigo-600"></i> Posted 3 Days ago</p>
                        ...
                        <div class="flex items-center p-6 border-t border-gray-100 dark:border-gray-700">
                            <img src="@/assets/images/client/android.png" class="h-12 w-12 shadow-md dark:shadow-gray-800 rounded-md p-2 bg-white dark:bg-slate-900" alt="">

                            <div class="ltr:ml-3 rtl:mr-3">
                                <h6 class="mb-0 font-semibold text-base">Android Ltd.</h6>
                                <span class="text-slate-400 text-sm">China</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-md shadow dark:shadow-gray-800">
                        <div class="p-6">
                            <a href="page-job-detail.html" class="title h5 text-lg font-semibold hover:text-indigo-600">Sketch Designer</a>
                            <p class="text-slate-400 mt-2"><i class="uil uil-clock text-indigo-600"></i> Posted 3 Days ago</p>
