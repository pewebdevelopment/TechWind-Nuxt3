                                    ...
                                    <ul class="list-none sidebar-nav mb-0 mt-3" id="navmenu-nav">
                                        <li class="navbar-item account-menu">
                                            <a href="user-profile.html" class="navbar-link text-slate-400 flex items-center py-2 rounded">
                                                <span class="ltr:mr-2 rtl:ml-2 text-[18px] mb-0"><i class="uil uil-dashboard"></i></span>
                                        ...
                                        <li class="navbar-item account-menu">
                                            <a href="user-billing.html" class="navbar-link text-slate-400 flex items-center py-2 rounded">
                                                <span class="ltr:mr-2 rtl:ml-2 text-[18px] mb-0"><i class="uil uil-diary-alt"></i></span>
                                        ...
                                        <li class="navbar-item account-menu">
                                            <a href="user-payment.html" class="navbar-link text-slate-400 flex items-center py-2 rounded">
                                                <span class="ltr:mr-2 rtl:ml-2 text-[18px] mb-0"><i class="uil uil-credit-card"></i></span>
                                        ...
                                        <li class="navbar-item account-menu">
                                            <a href="user-invoice.html" class="navbar-link text-slate-400 flex items-center py-2 rounded">
                                                <span class="ltr:mr-2 rtl:ml-2 text-[18px] mb-0"><i class="uil uil-receipt"></i></span>
                                        ...
                                        <li class="navbar-item account-menu">
                                            <a href="user-social.html" class="navbar-link text-slate-400 flex items-center py-2 rounded">
                                                <span class="ltr:mr-2 rtl:ml-2 text-[18px] mb-0"><i class="uil uil-process"></i></span>
                                        ...
                                        <li class="navbar-item account-menu">
                                            <a href="user-notification.html" class="navbar-link text-slate-400 flex items-center py-2 rounded">
                                                <span class="ltr:mr-2 rtl:ml-2 text-[18px] mb-0"><i class="uil uil-bell"></i></span>
                                        ...
                                        <li class="navbar-item account-menu">
                                            <a href="user-setting.html" class="navbar-link text-slate-400 flex items-center py-2 rounded">
                                                <span class="ltr:mr-2 rtl:ml-2 text-[18px] mb-0"><i class="uil uil-setting"></i></span>
                                        ...
                                        <li class="navbar-item account-menu">
                                            <a href="auth-lock-screen.html" class="navbar-link text-slate-400 flex items-center py-2 rounded">
                                                <span class="ltr:mr-2 rtl:ml-2 text-[18px] mb-0"><i class="uil uil-power"></i></span>
                        ...
                        <div class="grid lg:grid-cols-2 grid-cols-1 gap-[30px] pt-6">
                            <div>
                                ...
                                <div class="mt-6">
                                    <div class="flex items-center">
                                        <i data-feather="mail" class="fea icon-ex-md text-slate-400 ltr:mr-3 rtl:ml-3"></i>
                                        <div class="flex-1">
                                    ...
                                    <div class="flex items-center mt-3">
                                        <i data-feather="bookmark" class="fea icon-ex-md text-slate-400 ltr:mr-3 rtl:ml-3"></i>
                                        <div class="flex-1">
                                    ...
                                    <div class="flex items-center mt-3">
                                        <i data-feather="italic" class="fea icon-ex-md text-slate-400 ltr:mr-3 rtl:ml-3"></i>
                                        <div class="flex-1">
                                    ...
                                    <div class="flex items-center mt-3">
                                        <i data-feather="globe" class="fea icon-ex-md text-slate-400 ltr:mr-3 rtl:ml-3"></i>
                                        <div class="flex-1">
                                    ...
                                    <div class="flex items-center mt-3">
                                        <i data-feather="gift" class="fea icon-ex-md text-slate-400 ltr:mr-3 rtl:ml-3"></i>
                                        <div class="flex-1">
                                    ...
                                    <div class="flex items-center mt-3">
                                        <i data-feather="map-pin" class="fea icon-ex-md text-slate-400 ltr:mr-3 rtl:ml-3"></i>
                                        <div class="flex-1">
                                    ...
                                    <div class="flex items-center mt-3">
                                        <i data-feather="phone" class="fea icon-ex-md text-slate-400 ltr:mr-3 rtl:ml-3"></i>
                                        <div class="flex-1">
                            ...
                            <div class="mt-[30px] lg:mt-0">
                                ...
                                <div class="flex transition-all duration-500 hover:scale-105 shadow dark:shadow-gray-800 hover:shadow-md dark:hover:shadow-gray-700 ease-in-out items-center p-4 rounded-md bg-white dark:bg-slate-900 mt-6">
                                    ...
                                    <div class="flex-1 content ltr:ml-4 rtl:mr-4">
                        ...
                        <div class="grid lg:grid-cols-3 md:grid-cols-2 mt-6 gap-[30px]">
                            ...
                            <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                                ...
                                <div class="content transition-all duration-500">
                                    ...
                                    <div class="absolute z-10 hidden group-hover:block bottom-6 ltr:left-6 rtl:right-6 transition-all duration-500">
                                        <a href="portfolio-detail-three.html" class="h6 text-lg font-medium hover:text-indigo-600 duration-500 ease-in-out">Mockup Collection</a>
                                        <p class="text-slate-400 mb-0">Abstract</p>
                                    </div>
                                </div>
