            ...
            <div id="grid" class="md:flex justify-center mx-auto mt-4">
                ...
                <div class="lg:w-1/3 md:w-1/3 p-4 picture-item" data-groups='["development"]'>
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        ...
                        <div class="content pt-3">
                            <h5 class="mb-1"><a href="portfolio-detail-one.html"
                                    class="hover:text-indigo-600 transition-all duration-500 font-semibold">Yellow bg
                                    with Books</a></h5>
                ...
                <div class="lg:w-1/3 md:w-1/3 p-4 picture-item" data-groups='["branding"]'>
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        ...
                        <div class="content pt-3">
                            <h5 class="mb-1"><a href="portfolio-detail-one.html"
                                    class="hover:text-indigo-600 transition-all duration-500 font-semibold">Mockup box
                                    with paints</a></h5>
                ...
                <div class="lg:w-1/3 md:w-1/3 p-4 picture-item" data-groups='["designing"]'>
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        ...
                        <div class="content pt-3">
                            <h5 class="mb-1"><a href="portfolio-detail-one.html"
                                    class="hover:text-indigo-600 transition-all duration-500 font-semibold">Coffee
                                    cup</a></h5>
                ...
                <div class="lg:w-1/3 md:w-1/3 p-4 picture-item" data-groups='["photography"]'>
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        <a href="portfolio-detail-one.html"><img src="@/assets/images/portfolio/010.jpg"
                                class="rounded-md" alt=""></a>
                        <div class="content pt-3">
                            <h5 class="mb-1"><a href="portfolio-detail-one.html"
                                    class="hover:text-indigo-600 transition-all duration-500 font-semibold">Logo
                                    Vectors</a></h5>
                ...
                <div class="lg:w-1/3 md:w-1/3 p-4 picture-item" data-groups='["branding"]'>
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        <a href="portfolio-detail-one.html"><img src="@/assets/images/portfolio/011.jpg"
                                class="rounded-md" alt=""></a>
                        <div class="content pt-3">
                            <h5 class="mb-1"><a href="portfolio-detail-one.html"
                                    class="hover:text-indigo-600 transition-all duration-500 font-semibold">Black and
                                    white T-shirt</a></h5>
                ...
                <div class="lg:w-1/3 md:w-1/3 p-4 picture-item" data-groups='["branding"]'>
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        <a href="portfolio-detail-one.html"><img src="@/assets/images/portfolio/012.jpg"
                                class="rounded-md" alt=""></a>
                        <div class="content pt-3">
                            <h5 class="mb-1"><a href="portfolio-detail-one.html"
                                    class="hover:text-indigo-600 transition-all duration-500 font-semibold">Yellow bg
