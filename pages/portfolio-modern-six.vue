    ...
    <section class="relative md:py-24 py-16">
        ...
        <div class="container-fluid relative">
            <div id="grid" class="md:flex justify-center mx-auto mt-4">
                <div class="lg:w-1/6 md:w-1/2 p-4 picture-item" data-groups='["branding"]'>
                ...
                <div class="lg:w-1/6 md:w-1/2 p-4 picture-item" data-groups='["designing"]'>
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                ...
                <div class="lg:w-1/6 md:w-1/2 p-4 picture-item" data-groups='["photography"]'>
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                ...
                <div class="lg:w-1/6 md:w-1/2 p-4 picture-item" data-groups='["development"]'>
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
