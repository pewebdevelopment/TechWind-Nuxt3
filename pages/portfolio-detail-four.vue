            ...
            <div class="grid grid-cols-1">
                <div class="tiny-single-item">
                    <div class="tiny-slide">
                        <div class="m-2">
                            <img src="assets/images/portfolio/16.jpg" class="rounded-md shadow dark:shadow-gray-800"
                                alt="">
                        </div>
                    </div>
                    <div class="tiny-slide">
                        <div class="m-2">
                            <img src="assets/images/portfolio/17.jpg" class="rounded-md shadow dark:shadow-gray-800"
                                alt="">
                        </div>
                    </div>
                    <div class="tiny-slide">
                        <div class="m-2">
                            <img src="assets/images/portfolio/18.jpg" class="rounded-md shadow dark:shadow-gray-800"
                                alt="">
                        </div>
                    </div>
                </div>
            ...
            <div class="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                <div class="lg:col-span-4 md:col-span-5">
                    <div class="bg-gray-50 dark:bg-slate-800 shadow dark:shadow-gray-800 p-6 rounded-md">
                        <h5 class="text-lg font-semibold border-b border-gray-100 dark:border-gray-700 pb-3 mb-3">
                            Project Info :</h5>
                ...
                <div class="lg:col-span-8 md:col-span-7">
                    <div class="ltr:lg:mr-5 rtl:lg:ml-5">
                        <h4 class="text-xl font-semibold mb-3 border-b border-gray-100 dark:border-gray-700 pb-3">
                            Project Name :</h4>
