        ...
        <div class="container md:mt-24 mt-16">
            <div class="md:flex">
                ...
                <div class="lg:w-3/4 md:w-2/3 md:px-3 mt-[30px] md:mt-0">
                    <div class="rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900 mt-[30px]">
                                    ...
                                    <form>
                                        <div class="form-icon relative">
                                            <i data-feather="youtube"
                                                class="w-4 h-4 absolute top-3 ltr:left-4 rtl:right-4"></i>
                                            <input type="url" class="form-input ltr:pl-12 rtl:pr-12"
                                                placeholder="Youtube url" id="you_url" name="url" required="false">
                                        </div>
                                    </form>
