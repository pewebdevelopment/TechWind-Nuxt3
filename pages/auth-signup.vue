            ...
            <div class="container">
                <div class="flex justify-center">
                    <div class="max-w-[400px] w-full m-auto p-6 bg-white dark:bg-slate-900 shadow-md dark:shadow-gray-800 rounded-md">
                        ...
                        <form action="auth-signup-success.html" class="ltr:text-left rtl:text-right">
                            <div class="grid grid-cols-1">
                                ...
                                <div class="mb-4">
                                    <div class="flex items-center w-full mb-0">
                                        <input class="form-checkbox text-indigo-600 rounded w-4 h-4 ltr:mr-2 rtl:ml-2 border border-inherit" type="checkbox" value="" id="AcceptT&C">
                                ...
                                <div class="text-center">
                                    <span class="text-slate-400 ltr:mr-2 rtl:ml-2">Already have an account ? </span> <a href="auth-login.html" class="text-black dark:text-white font-bold inline-block">Sign in</a>
                                </div>
                            </div>
                        </form>
                    </div>
