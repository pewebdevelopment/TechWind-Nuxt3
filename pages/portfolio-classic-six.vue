                ...
                <div class="filters-group-wrap text-center">
                    <div class="filters-group">
                        <ul class="mb-0 list-none container-filter-box filter-options">
                            <li class="inline-block font-medium text-base mx-1.5 mb-3 py-1 px-3 cursor-pointer relative text-slate-400 border border-gray-100 dark:border-gray-700 rounded-md transition duration-500 active"
                                data-group="all">All</li>
                            <li class="inline-block font-medium text-base mx-1.5 mb-3 py-1 px-3 cursor-pointer relative text-slate-400 border border-gray-100 dark:border-gray-700 rounded-md transition duration-500"
            ...
            <div id="grid" class="md:flex justify-center mx-auto mt-4">
                <div class="lg:w-1/6 md:w-1/3 p-4 picture-item" data-groups='["branding"]'>
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        <a href="portfolio-detail-one.html"><img src="@/assets/images/portfolio/01.jpg" class="rounded-md"
                                alt=""></a>
                        <div class="content pt-3">
                            <h5 class="mb-1"><a href="portfolio-detail-one.html"
                                    class="hover:text-indigo-600 transition-all duration-500 font-semibold">Iphone
                                    mockup</a></h5>
                ...
                <div class="lg:w-1/6 md:w-1/3 p-4 picture-item" data-groups='["designing"]'>
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        <a href="portfolio-detail-one.html"><img src="@/assets/images/portfolio/02.jpg" class="rounded-md"
                                alt=""></a>
                        <div class="content pt-3">
                            <h5 class="mb-1"><a href="portfolio-detail-one.html"
                                    class="hover:text-indigo-600 transition-all duration-500 font-semibold">Mockup
                                    Collection</a></h5>
                ...
                <div class="lg:w-1/6 md:w-1/3 p-4 picture-item" data-groups='["photography"]'>
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        <a href="portfolio-detail-one.html"><img src="@/assets/images/portfolio/03.jpg" class="rounded-md"
                                alt=""></a>
                        <div class="content pt-3">
                            <h5 class="mb-1"><a href="portfolio-detail-one.html"
                                    class="hover:text-indigo-600 transition-all duration-500 font-semibold">Abstract
                                    images</a></h5>
                ...
                <div class="lg:w-1/6 md:w-1/3 p-4 picture-item" data-groups='["development"]'>
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        <a href="portfolio-detail-one.html"><img src="@/assets/images/portfolio/04.jpg" class="rounded-md"
                                alt=""></a>
                        <div class="content pt-3">
                            <h5 class="mb-1"><a href="portfolio-detail-one.html"
                                    class="hover:text-indigo-600 transition-all duration-500 font-semibold">Yellow bg with
                                    Books</a></h5>
                ...
                <div class="lg:w-1/6 md:w-1/3 p-4 picture-item" data-groups='["branding"]'>
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        <a href="portfolio-detail-one.html"><img src="@/assets/images/portfolio/05.jpg" class="rounded-md"
                                alt=""></a>
                        <div class="content pt-3">
                            <h5 class="mb-1"><a href="portfolio-detail-one.html"
                                    class="hover:text-indigo-600 transition-all duration-500 font-semibold">Company
                                    V-card</a></h5>
                ...
                <div class="lg:w-1/6 md:w-1/3 p-4 picture-item" data-groups='["branding"]'>
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        <a href="portfolio-detail-one.html"><img src="@/assets/images/portfolio/06.jpg" class="rounded-md"
                                alt=""></a>
                        <div class="content pt-3">
                            <h5 class="mb-1"><a href="portfolio-detail-one.html"
                                    class="hover:text-indigo-600 transition-all duration-500 font-semibold">Mockup box with
                                    paints</a></h5>
                ...
                <div class="lg:w-1/6 md:w-1/3 p-4 picture-item" data-groups='["designing"]'>
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        <a href="portfolio-detail-one.html"><img src="@/assets/images/portfolio/07.jpg" class="rounded-md"
                                alt=""></a>
                        <div class="content pt-3">
                            <h5 class="mb-1"><a href="portfolio-detail-one.html"
                                    class="hover:text-indigo-600 transition-all duration-500 font-semibold">Coffee cup</a>
                            </h5>
                ...
                <div class="lg:w-1/6 md:w-1/3 p-4 picture-item" data-groups='["development"]'>
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        <a href="portfolio-detail-one.html"><img src="@/assets/images/portfolio/08.jpg" class="rounded-md"
                                alt=""></a>
                        <div class="content pt-3">
                            <h5 class="mb-1"><a href="portfolio-detail-one.html"
                                    class="hover:text-indigo-600 transition-all duration-500 font-semibold">Pen and
                                    article</a></h5>
                ...
                <div class="lg:w-1/6 md:w-1/3 p-4 picture-item" data-groups='["photography"]'>
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        <a href="portfolio-detail-one.html"><img src="@/assets/images/portfolio/09.jpg" class="rounded-md"
                                alt=""></a>
                        <div class="content pt-3">
                            <h5 class="mb-1"><a href="portfolio-detail-one.html"
                                    class="hover:text-indigo-600 transition-all duration-500 font-semibold">White mockup
                                    box</a></h5>
                ...
                <div class="lg:w-1/6 md:w-1/3 p-4 picture-item" data-groups='["photography"]'>
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        <a href="portfolio-detail-one.html"><img src="@/assets/images/portfolio/010.jpg" class="rounded-md"
                                alt=""></a>
                        <div class="content pt-3">
                            <h5 class="mb-1"><a href="portfolio-detail-one.html"
                                    class="hover:text-indigo-600 transition-all duration-500 font-semibold">Logo Vectors</a>
                            </h5>
                ...
                <div class="lg:w-1/6 md:w-1/3 p-4 picture-item" data-groups='["branding"]'>
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        <a href="portfolio-detail-one.html"><img src="@/assets/images/portfolio/011.jpg" class="rounded-md"
                                alt=""></a>
                        <div class="content pt-3">
                            <h5 class="mb-1"><a href="portfolio-detail-one.html"
                                    class="hover:text-indigo-600 transition-all duration-500 font-semibold">Black and white
                                    T-shirt</a></h5>
                ...
                <div class="lg:w-1/6 md:w-1/3 p-4 picture-item" data-groups='["branding"]'>
                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                        <a href="portfolio-detail-one.html"><img src="@/assets/images/portfolio/012.jpg" class="rounded-md"
                                alt=""></a>
                        <div class="content pt-3">
                            <h5 class="mb-1"><a href="portfolio-detail-one.html"
                                    class="hover:text-indigo-600 transition-all duration-500 font-semibold">Yellow bg with
            ...
            <div class="grid grid-cols-1 text-center">
                ...
                <div class="mt-6">
                    <a href="contact-one.html"
                        class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-full"><i
