                            ...
                            <div class="grid lg:grid-cols-2 grid-cols-1 gap-5">
                                <div>
                                    ...
                                    <div class="form-icon relative mt-2">
                                        ...
                                        <input type="text" class="form-input ltr:pl-12 rtl:pr-12"
                                            placeholder="First Name:" id="firstname" name="name" required="false">
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div class="form-icon relative mt-2">
                                        <i data-feather="user-check"
                                            class="w-4 h-4 absolute top-3 ltr:left-4 rtl:right-4"></i>
                                        <input type="text" class="form-input ltr:pl-12 rtl:pr-12"
                                            placeholder="Last Name:" id="lastname" name="name" required="false">
                                    </div>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <div class="form-icon relative mt-2">
                                        ...
                                        <input name="name" id="occupation" type="text"
                                            class="form-input ltr:pl-12 rtl:pr-12" placeholder="Occupation :">
                                    </div>
                                </div>
                            </div><!--end grid-->
                                        ...
                                        <div>
                                            ...
                                            <div class="form-icon relative mt-2">
                                                ...
                                                <input name="number" id="number" type="number"
                                                    class="form-input ltr:pl-12 rtl:pr-12" placeholder="Phone :">
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="form-icon relative mt-2">
                                                ...
                                                <input name="url" id="url" type="url"
                                                    class="form-input ltr:pl-12 rtl:pr-12" placeholder="Url :">
                                            </div>
                                        </div>
                                    </div><!--end grid-->

                                    <button
                                        class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md mt-5">Add</button>
                                </form>
                            </div><!--end col-->
                                    ...
                                    <div class="grid grid-cols-1 gap-5">
                                        <div>
                                            ...
                                            <div class="form-icon relative mt-2">
                                                <i data-feather="key"
                                                    class="w-4 h-4 absolute top-3 ltr:left-4 rtl:right-4"></i>
                                                <input type="password" class="form-input ltr:pl-12 rtl:pr-12"
                                                    placeholder="Old password" required="false">
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="form-icon relative mt-2">
                                                <i data-feather="key"
                                                    class="w-4 h-4 absolute top-3 ltr:left-4 rtl:right-4"></i>
                                                <input type="password" class="form-input ltr:pl-12 rtl:pr-12"
                                                    placeholder="New password" required="false">
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="form-icon relative mt-2">
                                                <i data-feather="key"
                                                    class="w-4 h-4 absolute top-3 ltr:left-4 rtl:right-4"></i>
                                                <input type="password" class="form-input ltr:pl-12 rtl:pr-12"
                                                    placeholder="Re-type New password" required="false">
                                            </div>
                                        </div>
                                    </div><!--end grid-->

                                    <button
                                        class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md mt-5">Save
                                        password</button>
                                </form>
                            </div><!--end col-->
                        </div><!--end row-->
