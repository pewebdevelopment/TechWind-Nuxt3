                        ...
                        <div class="lg:-mt-[330px] -mt-[299px]">
                            <div class="rounded-md bg-white dark:bg-slate-900 shadow dark:shadow-gray-800">
                                ...
                                <div class="p-6">
                                    ...
                                    <a href="contact-one" class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md mt-6">Contact Me</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                                ...
                                <div class="content">
                                    ...
                                    <div class="title absolute z-10 hidden group-hover:block bottom-4 ltr:left-4 rtl:right-4">
                                        <a href="portfolio-detail-one" class="h6 text-md font-medium text-white hover:text-indigo-600 duration-500 ease-in-out">Mockup Collection</a>
