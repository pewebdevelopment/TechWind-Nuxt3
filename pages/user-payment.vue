<template>
                                ...
                                <ul class="list-none sidebar-nav mb-0 mt-3" id="navmenu-nav">
                                    <li class="navbar-item account-menu">
                                        <a href="user-profile.html"
                                            ...
                                            <span class="ltr:mr-2 rtl:ml-2 text-[18px] mb-0"><i
                ...
                <div class="lg:w-3/4 md:w-2/3 md:px-3 mt-[30px] md:mt-0">
                    <div class="rounded-md shadow dark:shadow-gray-800 bg-white dark:bg-slate-900">
                        <div
                            ...
                            <a href=""
                                class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md">Switch
                                to Annual Plan</a>
                        </div>

                        <div class="p-6">
                            <h5 class="text-2xl font-bold">$18/Monthly</h5>
                            <p class="text-slate-400 mt-2">Your next monthly charge of $18 will be applied to your
                                primary payment method on July 20, 2022.</p>
                        </div>
                    </div>
                        ...
                        <div class="px-6">
                            <ul>
                                <li class="flex justify-between items-center py-6">
                                    ...
                                    <div>
                                        <a href=""
                                            class="btn btn-icon bg-red-600/5 hover:bg-red-600 border-red-600/10 hover:border-red-600 text-red-600 hover:text-white rounded-full"><i
                                ...
                                <li
                                    ...
                                    <div class="flex items-center">
                                        <img src="@/assets/images/payments/american-ex.png"
                                            class="rounded shadow dark:shadow-gray-800 w-12" alt="">
                                ...
                                <li
                                    class="flex justify-between items-center py-6 border-t border-gray-100 dark:border-gray-700">
                                    <div class="flex items-center">
                                        <img src="@/assets/images/payments/discover.png"
                                            class="rounded shadow dark:shadow-gray-800 w-12" alt="">
                                ...
                                <li
                                    class="flex justify-between items-center py-6 border-t border-gray-100 dark:border-gray-700">
                                    <div class="flex items-center">
                                        <img src="@/assets/images/payments/master-card.png"
                                            class="rounded shadow dark:shadow-gray-800 w-12" alt="">
                                ...
                                <li class="py-6 border-t border-gray-100 dark:border-gray-700">
                                    <a href="#!" data-modal-toggle="paymentMethod"
                                        class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md">Add
                                        Payment Method</a>
                                </li>
                            </ul>
                        </div>
    ...
    <!-- Start Modal -->
    <div id="paymentMethod" tabindex="-1" class="fixed z-50 hidden overflow-hidden inset-0 m-auto">
        <div class="relative w-full h-auto max-w-md p-4">
            <div class="relative bg-white dark:bg-slate-900 rounded-lg shadow dark:shadow-gray-800">
                <div class="flex justify-between items-center px-6 py-4 border-b border-gray-100 dark:border-gray-700">
                    <h5 class="text-xl font-semibold">Add Payment Method</h5>
                    <button type="button"
                ...
                <div class="p-6 text-center">
                    <form>
                        <div class="grid grid-cols-1">
                            <div class="lg:col-span-6 mb-5">
                                <div class="ltr:text-left rtl:text-right">
                                    ...
                                    <input name="name" id="name" type="text" class="form-input mt-2" required
                                        placeholder="Name :">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid lg:grid-cols-12 lg:gap-6">
                            <div class="lg:col-span-6 mb-5">
                                <div class="ltr:text-left rtl:text-right">
                                    ...
                                    <select id="ex_month" class="form-input mt-2">
                                        <option>Jan</option>
                                        <option>Feb</option>
                                        <option>Mar</option>
                                        <option>Apr</option>
                            ...
                            <div class="lg:col-span-6 mb-5">
                                <div class="ltr:text-left rtl:text-right">
                                    ...
                                    <select id="ex_year" class="form-input mt-2">
                                        <option>2022</option>
                                        <option>2023</option>
                                        <option>2024</option>
                                        <option>2025</option>
                            ...
                            <div class="lg:col-span-6 mb-5">
                                <div class="ltr:text-left rtl:text-right">
                                    ...
                                    <input name="number" id="card_number" type="number" class="form-input mt-2" required
                                        placeholder="number :">
                                </div>
                            </div>
                            ...
                            <div class="lg:col-span-6 mb-5">
                                <div class="ltr:text-left rtl:text-right">
                                    ...
                                    <input name="number" id="cvv_number" type="number" class="form-input mt-2" required
                                        placeholder="number :">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1">
                            <div class="mb-5">
                                <div class="ltr:text-left rtl:text-right">
                                    ...
                                    <select id="card_names" class="form-input mt-2">
                                        <option>Visa</option>
                        ...
                        <button type="submit" id="submit" name="send"
                            class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md justify-center flex items-center">Add
                            Card</button>
                    </form>
                </div>
            </div>
