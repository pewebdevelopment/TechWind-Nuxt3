        ...
        <section class="relative table w-full py-32 lg:py-40 bg-gray-50 dark:bg-slate-800">
            ...
            <div class="absolute text-center z-10 bottom-5 right-0 left-0 mx-3">
                <ul class="breadcrumb tracking-[0.5px] mb-0 inline-block">
                    ...
                    <li class="inline breadcrumb-item uppercase text-[13px] font-bold duration-500 ease-in-out hover:text-indigo-600"><a href="index-forums.html">Forums</a></li>
                    <li class="inline breadcrumb-item uppercase text-[13px] font-bold duration-500 ease-in-out hover:text-indigo-600"><a href="forums-topic.html">Topic</a></li>
                ...
                <div class="grid lg:grid-cols-12 grid-cols-1 gap-[30px]">
                        ...
                        <div class="rounded shadow dark:shadow-slate-800">
                            ...
                            <div class="p-6 border-b border-gray-100 dark:border-gray-800">
                                <div class="sm:flex items-center justify-between">
                                    ...
                                    <p class="text-slate-400 text-sm font-normal mt-3 sm:mt-0"><i class="uil uil-clock"></i> 16th Januanry, 2023 at 03:44 pm</p>
                                </div>

                                <p class="text-slate-400 mt-4">" Dummy text is text that is used in the publishing industry or by web designers to occupy the space which will later be filled with 'real' content. This is required when, for example, the final text is not yet available."</p>
                            </div>

                            <div class="p-6 border-b border-gray-100 dark:border-gray-800">
                                <div class="sm:flex items-center justify-between">
                                    <div class="flex items-center">
                                        <img src="@/assets/images/client/03.jpg" class="h-10 rounded-full shadow dark:shadow-slate-800" alt="">

                                        <div class="ltr:ml-3 rtl:mr-3">
                                            <a href="" class="hover:text-indigo-600 font-semibold">Alia Reddy</a>
                                            <p class="text-slate-400 text-sm font-normal"><i class="uil uil-user"></i> Author</p>
                                        </div>
                                    </div>
                                    <p class="text-slate-400 text-sm font-normal mt-3 sm:mt-0"><i class="uil uil-clock"></i> 16th Januanry, 2023 at 03:44 pm</p>
                            ...
                            <div class="p-6 border-b border-gray-100 dark:border-gray-800">
                                <div class="sm:flex items-center justify-between">
                                    <div class="flex items-center">
                                        <img src="@/assets/images/client/02.jpg" class="h-10 rounded-full shadow dark:shadow-slate-800" alt="">

                                        <div class="ltr:ml-3 rtl:mr-3">
                                            <a href="" class="hover:text-indigo-600 font-semibold">Cristino Murphy</a>
                                            <p class="text-slate-400 text-sm font-normal"><i class="uil uil-user"></i> Author</p>
                                        </div>
                                    </div>
                                    <p class="text-slate-400 text-sm font-normal mt-3 sm:mt-0"><i class="uil uil-clock"></i> 16th Januanry, 2023 at 03:44 pm</p>
                    ...
                    <div class="lg:col-span-4 md:col-span-6">
                        <div class="sticky top-20">
                            <h5 class="text-lg font-semibold bg-gray-50 dark:bg-slate-800 shadow dark:shadow-gray-800 rounded-md p-2 text-center">Sign In</h5>
                                ...
                                <div class="grid grid-cols-1">
                                    ...
                                    <div class="flex justify-between mb-4">
                                        <label for="RememberMe" class="inline-flex items-center">
                                            <input type="checkbox" class="form-checkbox border dark:border-gray-700 rounded text-indigo-600">
                                            <span class="text-slate-400 ml-2">Remember me</span>
                                        </label>
                            ...
                            <h5 class="text-lg font-semibold bg-gray-50 dark:bg-slate-800 shadow dark:shadow-gray-800 rounded-md p-2 text-center mt-8">Recent Reply</h5>
