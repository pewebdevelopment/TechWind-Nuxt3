                    ...
                    <div
                        ...
                        <div class="relative bg-indigo-600 overflow-hidden rounded-md">
                            <a href="@/assets/images/portfolio/1.jpg"
                                class="lightbox transition-all duration-700 ease-in-out group-hover:p-[10px]" title="">
                                <img src="@/assets/images/portfolio/1.jpg" class="rounded-md" alt="">
                            </a>
                        </div>
                        <div class="content transition-all duration-700 ease-in-out">
                            <div
                                class="bg-white dark:bg-slate-900 p-3 rounded-md absolute z-10 bottom-5 ltr:left-5 rtl:right-5 transition-all duration-700 ease-in-out scale-0 group-hover:scale-100">
