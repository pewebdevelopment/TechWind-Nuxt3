                ...
                <div class="grid grid-cols-1 pb-8 text-center mt-10">
                    ...
                    <div class="text-center subcribe-form mt-4 pt-2">
                        <form class="relative mx-auto max-w-xl">
                            <input type="text" id="help" name="name" class="pt-4 ltr:pr-40 rtl:pl-40 pb-4 ltr:pl-6 rtl:pr-6 w-full h-[50px] outline-none text-black dark:text-white rounded-full bg-white opacity-70 dark:bg-slate-900 border border-gray-100 dark:border-gray-700" placeholder="Search your questions or topic...">
                            <button type="submit" class="btn absolute top-[2px] ltr:right-[3px] rtl:left-[3px] h-[46px] bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-full">Search</button>
                        </form><!--end form-->
                    </div>
                </div><!--end grid-->
            </div><!--end container-->
            ...
            <div class="absolute text-center z-10 bottom-5 right-0 left-0 mx-3">
                <ul class="breadcrumb tracking-[0.5px] breadcrumb-light mb-0 inline-block">
                   <li class="inline breadcrumb-item uppercase text-[13px] font-bold duration-500 ease-in-out text-white/50 hover:text-white"><a href="/index">Techwind</a></li>
                    <li class="inline breadcrumb-item uppercase text-[13px] font-bold duration-500 ease-in-out text-white" aria-current="page">Helpcenter</li>
                </ul>
            </div>
        </section><!--end section-->
        <div class="relative">
        ...
        <section class="relative md:py-24 py-16">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 mt-6 gap-[30px]">
                    <div class="text-center px-6 mt-6">
                        ...
                        <div class="content mt-7">
                            <a href="/helpcenter-faqs" class="title h5 text-lg font-medium hover:text-indigo-600">FAQs</a>
                            <p class="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                            
                            <div class="mt-5">
                                <a href="/helpcenter-faqs" class="btn btn-link text-indigo-600 hover:text-indigo-600 after:bg-indigo-600 duration-500 ease-in-out">Read More <i class="uil uil-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-center px-6 mt-6">
                        ...
                        <div class="content mt-7">
                            <a href="/helpcenter-guides" class="title h5 text-lg font-medium hover:text-indigo-600">Guides / Support</a>
                            <p class="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                            
                            <div class="mt-5">
                                <a href="/helpcenter-guides" class="btn btn-link text-indigo-600 hover:text-indigo-600 after:bg-indigo-600 duration-500 ease-in-out">Read More <i class="uil uil-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-center px-6 mt-6">
                        ...
                        <div class="content mt-7">
                            <a href="/helpcenter-support" class="title h5 text-lg font-medium hover:text-indigo-600">Support Request</a>
                            <p class="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                            
                            <div class="mt-5">
                                <a href="/helpcenter-support" class="btn btn-link text-indigo-600 hover:text-indigo-600 after:bg-indigo-600 duration-500 ease-in-out">Read More <i class="uil uil-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div><!--end grid-->
            ...
            <div class="container md:mt-24 mt-16">
                ...
                <div class="grid md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                    <div class="flex">
                        <i data-feather="help-circle" class="fea icon-ex-md text-indigo-600 ltr:mr-3 rtl:ml-3"></i>
                        <div class="flex-1">
            ...
            <div class="container md:mt-24 mt-16">
                <div class="grid grid-cols-1 text-center">
                    ...
                    <div class="mt-6">
                        <a href="/helpcenter-support" class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md ltr:mr-2 rtl:ml-2 mt-2"><i class="uil uil-phone"></i> Contact us</a>
                    </div>
                </div><!--end grid-->
            </div><!--end container-->
        </section><!--end section-->
