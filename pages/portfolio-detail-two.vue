<template>
    <!-- Start Hero -->
    <section
        class="relative table w-full py-32 lg:py-48 bg-[url('../../assets/images/portfolio/bg-inner.jpg')] bg-no-repeat bg-center bg-cover">
        ...
        <div class="container">
            <div class="grid grid-cols-1 pb-8 text-center mt-10">
                ...
                <ul class="list-none">
                    <li class="inline font-semibold text-white/60 ltr:mr-2 rtl:ml-2"> <span class="text-white">Client
                            :</span> Calvin Carlo</li>
                    <li class="inline font-semibold text-white/60"> <span class="text-white">Date :</span> 23th May,
                        2022</li>
                </ul>
            </div><!--end grid-->
        </div><!--end container-->
            ...
            <div class="grid grid-cols-1 justify-center">
                <div class="relative z-2 transition-all duration-500 ease-in-out sm:-mt-[200px] -mt-[140px] m-0">
                    <div id="grid" class="md:flex justify-center mx-auto">
                        ...
                        <div class="lg:w-1/4 md:w-1/3 p-1 picture-item" data-groups='["designing"]'>
                            <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                                <a href="@/assets/images/portfolio/15.jpg"
                                    class="lightbox transition-all duration-500 group-hover:scale-105" title="">
            ...
            <div class="flex mx-auto justify-center">
                <div class="lg:w-2/3 md:w-full">
                    <div class="text-center">
                        ...
                        <p class="text-slate-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit
                            totam atque dignissimos porro, exercitationem, neque alias ea aliquid quibusdam voluptates
                            impedit maxime aut asperiores consequatur iste. Corporis fuga ducimus dignissimos. Lorem
                            ipsum dolor sit amet, consectetur adipisicing elit. Adipisci non dolorem consequatur vitae
                            hic.</p>
                        <p class="text-slate-400 mt-2">Suscipit totam atque dignissimos porro, exercitationem, neque
                            alias ea aliquid quibusdam voluptates impedit maxime aut asperiores consequatur iste.
                            Corporis fuga ducimus dignissimos.</p>
                    </div>
                </div><!--end col-->
            </div><!--end grid-->
        </div><!--end container-->
