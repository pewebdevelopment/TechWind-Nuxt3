                            ...
                            <form class="ltr:text-left rtl:text-right">
                                <div class="grid grid-cols-1">
                                    ...
                                    <div class="text-center">
                                        <span class="text-slate-400 ltr:mr-2 rtl:ml-2">Remember your password ? </span><a href="auth-login.html" class="text-black dark:text-white font-bold inline-block">Sign in</a>
                                    </div>
                                </div>
                            </form>
                        </div>
