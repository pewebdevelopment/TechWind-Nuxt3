<template>
    <!-- Start Hero -->
    <section class="relative md:py-64 py-36 items-center bg-[url('../../assets/images/bg-seo.png')] bg-center bg-no-repeat bg-cover">
            <div class="container">
                    ...
                    <div class="">
                        ...
                        <div class="subcribe-form mt-6 mb-3">
                            <form class="relative max-w-xl mx-auto">
                                <input type="url" id="site-url" name="url" class="pt-4 ltr:pr-40 rtl:pl-40 pb-4 ltr:pl-6 rtl:pr-6 w-full h-[50px] outline-none text-black dark:text-white rounded-full bg-white/60 dark:bg-slate-900/60 shadow dark:shadow-gray-800" placeholder="http://www.yourdomain.com">
                                <button type="submit" class="btn absolute top-[2px] ltr:right-[3px] rtl:left-[3px] h-[46px] bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-full">Start Free Trial</button>
                            </form><!--end form-->
                        </div>
                            ...
                            <div class="md:flex justify-center">
                                <div class="md:w-1/3">
                                    <div class="text-center">
                                        <h6 class="text-slate-400 mb-0">External Backlinks</h6>
                                        <h2 class="mb-0 text-4xl mt-3 font-bold"><span class="counter-value" data-target="2021">1990</span>K+</h2>
                                    </div>
                                </div>

                                <div class="md:w-1/3 mt-8 md:mt-0">
                                    <div class="text-center">
                                        <h6 class="text-slate-400 mb-0">Pages Crawled Daily</h6>
                                        <h2 class="mb-0 text-4xl mt-3 font-bold"><span class="counter-value" data-target="210">2</span>B+</h2>
                                    </div>
                                </div>

                                <div class="md:w-1/3 mt-8 md:mt-0">
                                    <div class="text-center">
                                        <h6 class="text-slate-400 mb-0">Domain Indexed</h6>
                                        <h2 class="mb-0 text-4xl mt-3 font-bold"><span class="counter-value" data-target="18">1</span>M+</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 mt-6 gap-[30px]">
                    <div class="p-6 hover:shadow-xl hover:shadow-gray-100 dark:hover:shadow-gray-800 transition duration-500 rounded-2xl mt-6">
                        ...
                        <div class="content mt-7">
                            <a href="page-services.html" class="title h5 text-lg font-medium hover:text-indigo-600">SEO</a>
                    ...
                    <div class="p-6 shadow-xl shadow-gray-100 dark:shadow-gray-800 transition duration-500 rounded-2xl mt-6">
                        ...
                        <div class="content mt-7">
                            <a href="page-services.html" class="title h5 text-lg font-medium hover:text-indigo-600">Content Marketing</a>
                            <p class="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                    ...
                    <div class="p-6 hover:shadow-xl hover:shadow-gray-100 dark:hover:shadow-gray-800 transition duration-500 rounded-2xl mt-6">
                        ...
                        <div class="content mt-7">
                            <a href="page-services.html" class="title h5 text-lg font-medium hover:text-indigo-600">Branding</a>
                            <p class="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                    ...
                    <div class="p-6 shadow-xl shadow-gray-100 dark:shadow-gray-800 transition duration-500 rounded-2xl mt-6">
                        ...
                        <div class="content mt-7">
                            <a href="page-services.html" class="title h5 text-lg font-medium hover:text-indigo-600">Analytics</a>
                            <p class="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                    ...
                    <div class="p-6 hover:shadow-xl hover:shadow-gray-100 dark:hover:shadow-gray-800 transition duration-500 rounded-2xl mt-6">
                        ...
                        <div class="content mt-7">
                            <a href="page-services.html" class="title h5 text-lg font-medium hover:text-indigo-600">Management</a>
                            <p class="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                    ...
                    <div class="p-6 shadow-xl shadow-gray-100 dark:shadow-gray-800 transition duration-500 rounded-2xl mt-6">
                        ...
                        <div class="content mt-7">
                            <a href="page-services.html" class="title h5 text-lg font-medium hover:text-indigo-600">Email Marketing</a>
                            <p class="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                        ...
                        <div class="sticky top-20">
                            <ul class="flex-column p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 rounded-md" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
                                <li role="presentation">
                                    <button class="px-4 py-2 ltr:text-left rtl:text-right text-base font-semibold rounded-md w-full hover:text-indigo-600 transition-all duration-500 ease-in-out" id="profile-tab" data-tabs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="true">
                                ...
                                <li role="presentation">
                                    <button class="px-4 py-2 ltr:text-left rtl:text-right text-base font-semibold rounded-md w-full mt-6 transition-all duration-500 ease-in-out" id="dashboard-tab" data-tabs-target="#dashboard" type="button" role="tab" aria-controls="dashboard" aria-selected="false">
                                        <span class="block">Step 2</span>
                                        <span class="text-xl mt-2 block">Project Execution</span>
                                        <span class="block mt-2">We offer flexible and comprehensive online marketing plans</span>
                                    </button>
                                </li>
                                <li role="presentation">
                                    <button class="px-4 py-2 ltr:text-left rtl:text-right text-base font-semibold rounded-md w-full mt-6 transition-all duration-500 ease-in-out" id="settings-tab" data-tabs-target="#settings" type="button" role="tab" aria-controls="settings" aria-selected="false">
                                        <span class="block">Step 3</span>
                                        <span class="text-xl mt-2 block">Results & Reporting</span>
                                        <span class="block mt-2">We offer flexible and comprehensive online marketing plans</span>
                                    </button>
                                </li>
                            </ul>
        ...
        <section class="realtive md:py-24 py-16">
            <div class="container">
                <div class="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                    <div class="md:col-span-6">
                        <div class="relative ltr:lg:mr-8 rtl:lg:ml-8">
                            <img src="@/assets/images/business/about01.jpg" class="rounded-md" alt="">

                            <div class="absolute bottom-24 ltr:right-0 rtl:left-0">
                    ...
                    <div class="md:col-span-6 mt-8 md:mt-0">
                        <div class="ltr:lg:ml-5 rtl:lg:mr-5">
                            ...
                            <a href="" class="btn bg-indigo-600/5 hover:bg-indigo-600 border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white rounded-md">Get Started</a>
                        </div>
                    </div><!--end col-->
                </div><!--end grid-->
            </div><!--end container-->
            ...
            <div class="container md:mt-24 mt-16">
                ...
                <div class="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                    <ul class="space-y-8">
                        <li class="rounded-lg shadow-lg dark:shadow-gray-800 p-6">
                            <div class="flex items-center pb-6 border-b border-gray-100 dark:border-gray-800">
                                <img src="@/assets/images/client/01.jpg" class="h-16 w-16 rounded-full shadow dark:shadow-gray-800" alt="">

                                <div class="ltr:pl-4 rtl:pr-4">
                                    <a href="" class="text-lg hover:text-indigo-600 duration-500 ease-in-out">Thomas Israel</a>
                        ...
                        <li class="rounded-lg shadow-lg dark:shadow-gray-800 p-6">
                            <div class="flex items-center pb-6 border-b border-gray-100 dark:border-gray-800">
                                ...
                                <div class="ltr:pl-4 rtl:pr-4">
                                    <a href="" class="text-lg hover:text-indigo-600 duration-500 ease-in-out">Barbara McIntosh</a>
                                    <p class="text-slate-400">C.E.O</p>
                                </div>
                            </div>
                    ...
                    <ul class="space-y-8 hidden sm:block">
                        <li class="rounded-lg shadow-lg dark:shadow-gray-800 p-6">
                            <div class="flex items-center pb-6 border-b border-gray-100 dark:border-gray-800">
                                <img src="@/assets/images/client/02.jpg" class="h-16 w-16 rounded-full shadow dark:shadow-gray-800" alt="">

                                <div class="ltr:pl-4 rtl:pr-4">
                                    <a href="" class="text-lg hover:text-indigo-600 duration-500 ease-in-out">Carl Oliver</a>
                                    <p class="text-slate-400">C.E.O</p>
                                </div>
                            </div>
                        ...
                        <li class="rounded-lg shadow-lg dark:shadow-gray-800 p-6">
                            <div class="flex items-center pb-6 border-b border-gray-100 dark:border-gray-800">
                                <img src="@/assets/images/client/04.jpg" class="h-16 w-16 rounded-full shadow dark:shadow-gray-800" alt="">

                                <div class="ltr:pl-4 rtl:pr-4">
                                    <a href="" class="text-lg hover:text-indigo-600 duration-500 ease-in-out">Jill Webb</a>
                                    <p class="text-slate-400">C.E.O</p>
                                </div>
                            </div>
                    ...
                    <ul class="space-y-8 hidden lg:block">
                        <li class="rounded-lg shadow-lg dark:shadow-gray-800 p-6">
                            <div class="flex items-center pb-6 border-b border-gray-100 dark:border-gray-800">
                                <img src="@/assets/images/client/03.jpg" class="h-16 w-16 rounded-full shadow dark:shadow-gray-800" alt="">
                        ...
                        <li class="rounded-lg shadow-lg dark:shadow-gray-800 p-6">
                            <div class="flex items-center pb-6 border-b border-gray-100 dark:border-gray-800">
                                <img src="@/assets/images/client/06.jpg" class="h-16 w-16 rounded-full shadow dark:shadow-gray-800" alt="">

                                <div class="ltr:pl-4 rtl:pr-4">
                                    <a href="" class="text-lg hover:text-indigo-600 duration-500 ease-in-out">Janisha Doll</a>
                                    <p class="text-slate-400">C.E.O</p>
                                </div>
                            </div>
            ...
            <div class="container md:mt-24 mt-16">
                <div class="grid grid-cols-1 text-center">
                    ...
                    <div class="mt-6">
                        <a href="contact-one.html" class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md ltr:mr-2 rtl:ml-2 mt-2"><i class="uil uil-phone"></i> Contact Me</a>
                    </div>
                </div><!--end grid-->
            </div><!--end container-->
        </section><!--end section-->
