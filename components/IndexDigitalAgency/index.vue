                ...
                <div class="grid md:grid-cols-12 grid-cols-1 items-center mt-10 gap-[30px]">
                    <div class="md:col-span-6">
                        <div class="ltr:md:mr-6 rtl:md:ml-6">
                            <img src="@/assets/images/logo-icon-40.png" class="mb-5" alt="">
                            ...
                            <div class="mt-6">
                                <a href="#!" data-type="youtube" data-id="yba7hPeTSjk" class="btn btn-icon rounded-full bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white lightbox"><i data-feather="video" class="h-4 w-4"></i></a><span class="font-semibold ltr:ml-2 rtl:mr-2 align-middle">Watch Now</span>
                            </div>
                        </div>
                    </div><!--end col-->
        ...
        <section class="relative md:py-24 py-16">
            ...
            <div class="container md:mt-24 mt-16">
                <div class="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                    ...
                    <div class="md:col-span-6">
                        <div class="ltr:md:ml-6 rtl:md:mr-6">
            ...
            <div class="relative w-full h-auto max-w-md p-4">
                <div class="relative bg-white dark:bg-slate-900 rounded-lg shadow dark:shadow-gray-800">
                    <div class="flex justify-between items-center px-6 py-4 border-b border-gray-100 dark:border-gray-700">
                        ...
                        <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ltr:ml-auto rtl:mr-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="contactModal">
