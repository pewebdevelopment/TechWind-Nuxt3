<template>
        ...
        <div class="container">
            <div class="grid md:grid-cols-12 grid-cols-1 items-center mt-10 gap-[30px] relative">
                <div class="md:col-span-7">
                    <h4
                        class="font-bold lg:leading-normal leading-normal text-4xl lg:text-5xl mb-5 text-black dark:text-white">
                        Learn with <span class="text-indigo-600">Expert</span> <br> Anytime & Anywhere</h4>
                ...
                <div
                    class="overflow-hidden after:content-[''] after:absolute after:h-32 after:w-32 after:bg-red-600/5 after:top-10 ltr:after:left-0 rtl:after:right-0 after:-z-1 after:rounded-3xl after:animate-[spin_10s_linear_infinite]">
                </div>
                <div
                    class="overflow-hidden after:content-[''] after:absolute after:h-[512px] after:w-[512px] after:bg-indigo-600/5 after:top-0 ltr:after:-right-5 rtl:after:-left-5 after:-z-1 after:rounded-full">
                </div>
            </div><!--end grid-->
        </div><!--end container-->
    </section><!--end section-->
            ...
            <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                ...
                <div
                    ...
                    <div class="relative overflow-hidden text-transparent -m-3">
                        ...
                        <div
                            class="absolute top-2/4 -translate-y-2/4 left-0 right-0 mx-auto text-indigo-600 rounded-xl transition-all duration-500 ease-in-out text-4xl flex align-middle justify-center items-center">
                    ...
                    <div class="mt-6">
                        <a href=""
                            class="text-xl font-medium transition-all duration-500 ease-in-out hover:text-indigo-600">Faster</a>
                        <p class="text-slate-400 transition-all duration-500 ease-in-out mt-3">If the distribution of
                ...
                <div
                    ...
                    <div class="mt-6">
                        <a href=""
                            class="text-xl font-medium transition-all duration-500 ease-in-out hover:text-indigo-600">Cheaper</a>
                        <p class="text-slate-400 transition-all duration-500 ease-in-out mt-3">If the distribution of
                            letters and 'words' is random, the reader will not be distracted from making.</p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="mt-6">
                        <a href=""
                            class="text-xl font-medium transition-all duration-500 ease-in-out hover:text-indigo-600">At
                            Hand</a>
                        <p class="text-slate-400 transition-all duration-500 ease-in-out mt-3">If the distribution of
                            letters and 'words' is random, the reader will not be distracted from making.</p>
                    </div>
            ...
            <div class="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                ...
                <div class="lg:col-span-7 md:col-span-6">
                    <div class="ltr:lg:ml-5 rtl:lg:mr-5">
                        <h3 class="mb-6 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">Online Video
                            <br> Courses</h3>
                        ...
                        <div class="mt-6">
                            <a href=""
                                class="btn btn-link font-semibold text-indigo-600 after:bg-indigo-600 duration-500 ease-in-out">Learn
        ...
        <div class="container">
            <div class="grid md:grid-cols-12 grid-cols-1 pb-8 items-end">
                <div class="lg:col-span-8 md:col-span-6 ltr:md:text-left rtl:md:text-right text-center">
                    <h3 class="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">Browse Online
                ...
                <div class="tiny-five-item">
                    <div class="tiny-slide">
                        <div
                            ...
                            <div class="content mt-6">
                                <a href="" class="title h5 text-lg font-medium hover:text-indigo-600">UI / UX Design</a>
                    ...
                    <div class="tiny-slide">
                        <div
                            ...
                            <div class="content mt-6">
                                <a href="" class="title h5 text-lg font-medium hover:text-indigo-600">Web Development</a>
                    ...
                    <div class="tiny-slide">
                        <div
                            ...
                            <div class="content mt-6">
                                <a href="" class="title h5 text-lg font-medium hover:text-indigo-600">Graphic Design</a>
                                <p class="text-slate-400 mt-3">35 Lesson</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tiny-slide">
                        <div
                            ...
                            <div class="content mt-6">
                                <a href="" class="title h5 text-lg font-medium hover:text-indigo-600">PHP Development</a>
                    ...
                    <div class="tiny-slide">
                        <div
                            ...
                            <div class="content mt-6">
                                <a href="" class="title h5 text-lg font-medium hover:text-indigo-600">Data Science</a>
                    ...
                    <div class="tiny-slide">
                        <div
                            ...
                            <div class="content mt-6">
                                <a href="" class="title h5 text-lg font-medium hover:text-indigo-600">Digital Marketing</a>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 mt-8 gap-[30px]">
                ...
                <div
                    ...
                    <div class="relative overflow-hidden">
                        ...
                        <div
                            class="absolute ltr:left-0 rtl:right-0 bottom-0 opacity-0 group-hover:opacity-100 duration-500 ease-in-out">
                            <div class="pb-4 ltr:pl-4 rtl:pr-4 flex items-center">
                    ...
                    <div class="content p-6 relative">
                        ...
                        <ul
                            ...
                            <li class="flex items-center ltr:mr-4 rtl:ml-4">
                                <i
                                    class="uil uil-book-open text-lg leading-none ltr:mr-2 rtl:ml-2 text-slate-900 dark:text-white"></i>
                                <span>25 Lectures</span>
                            </li>

                            <li class="flex items-center ltr:mr-4 rtl:ml-4">
                                <i
                                    class="uil uil-clock text-lg leading-none ltr:mr-2 rtl:ml-2 text-slate-900 dark:text-white"></i>
                                <span>1h 30m</span>
                            </li>

                            <li class="flex items-center">
                                <i
                                    class="uil uil-eye text-lg leading-none ltr:mr-2 rtl:ml-2 text-slate-900 dark:text-white"></i>
                                <span>3012</span>
                            </li>
                        </ul>

                        <div
                            class="absolute -top-7 ltr:right-6 rtl:left-6 z-1 opacity-0 group-hover:opacity-100 duration-500 ease-in-out">
                            <div
                ...
                <div
                    ...
                    <div class="content p-6 relative">
                        <a href="course-detail.html" class="font-medium block text-indigo-600">Engineering</a>
                        <a href="course-detail.html"
                ...
                <div
                    ...
                    <div class="content p-6 relative">
                        <a href="course-detail.html" class="font-medium block text-indigo-600">Web Development</a>
                        <a href="course-detail.html"
                            class="text-lg font-medium block hover:text-indigo-600 duration-500 ease-in-out mt-2">Vue - The
                ...
                <div
                    ...
                    <div class="content p-6 relative">
                        <a href="course-detail.html" class="font-medium block text-indigo-600">Front-end Design</a>
                        <a href="course-detail.html"
                            class="text-lg font-medium block hover:text-indigo-600 duration-500 ease-in-out mt-2">HTML, CSS,
                ...
                <div
                    ...
                    <div class="content p-6 relative">
                        <a href="course-detail.html" class="font-medium block text-indigo-600">Back-end Development</a>
                        <a href="course-detail.html"
    ...
    <!-- Start -->
    <section
        class="relative md:py-24 py-16 bg-[url('../../assets/images/course/cta.jpg')] bg-no-repeat bg-fixed bg-top bg-cover"
        id="table">
        <div class="absolute inset-0 bg-black/50"></div>
        <div class="container">
            <div class="grid lg:grid-cols-12 md:grid-cols-2 items-center gap-[30px]">
                <div class="lg:col-span-7">
                    <h4 class="font-semibold lg:leading-normal leading-normal text-3xl lg:text-4xl mb-5 text-white">Register
                        Now !</h4>

                    <p class="text-white/70 text-lg max-w-xl">Launch your campaign and benefit from our expertise on
                        designing and managing conversion centered Tailwind CSS v3.x html page.</p>

                    <div class="relative mt-10">
                        <a href=""
                            class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md">Admission
                            Now</a>
                    </div>
                </div>
                ...
                <div class="lg:col-span-5">
                    <div
                        class="bg-white dark:bg-slate-900 rounded-xl shadow dark:shadow-gray-800 md:p-8 p-6 ltr:lg:ml-10 rtl:lg:mr-10 z-10 relative">
                            ...
                            <div class="grid grid-cols-1">
                                <div class="mb-5">
                                    ...
                                    <div class="form-icon relative mt-2">
                                        ...
                                        <input type="text" class="form-input ltr:pl-12 rtl:pr-12" placeholder="Name"
                                            name="name" required>
                                    </div>
                                </div>
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="form-icon relative mt-2">
                                        ...
                                        <input type="email" class="form-input ltr:pl-12 rtl:pr-12" placeholder="Email"
                                            name="email" required>
                                    </div>
                                </div>

                                <div class="mb-5">
                                    <label class="form-label font-medium">Phone No. : <span
                                            class="text-red-600">*</span></label>
                                    <div class="form-icon relative mt-2">
                                        <i data-feather="phone" class="w-4 h-4 absolute top-3 ltr:left-4 rtl:right-4"></i>
                                        <input name="number" id="phNumber" class="form-input ltr:pl-12 rtl:pr-12"
                                ...
                                <div>
                                    <a href=""
                                        class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md w-full">Free
                                        Trial</a>
                                </div>
                            </div><!--end grid-->
                        </form>
    ...
    <section class="relative md:py-24 py-16 overflow-hidden">
        ...
        <div class="container-fluid">
            <div class="grid grid-cols-1 mt-8">
                <div
                    class="slider relative overflow-hidden m-auto mb-4 before:content-[''] before:absolute before:top-0 before:left-0 before:z-2 after:content-[''] after:absolute after:top-0 after:right-0 after:z-2">
                    <div class="slide-track flex items-center">
                        <div class="slide h-auto md:w-[360px] w-72 m-2">
                            <ul class="space-y-4">
                                <li class="rounded-lg shadow dark:shadow-gray-800 p-6">
                                    <div class="flex items-center pb-6 border-b border-gray-100 dark:border-gray-800">
                                        <img src="assets/images/client/01.jpg"
                                            class="h-16 w-16 rounded-full shadow dark:shadow-gray-800" alt="">

                                        <div class="ltr:pl-4 rtl:pr-4">
                                            <a href="" class="text-lg hover:text-indigo-600 duration-500 ease-in-out">Thomas
                                                Israel</a>
                                    ...
                                    <div class="mt-6">
                                        <p class="text-slate-400">I didn't know a thing about icon design until I read this
                                ...
                                <li class="rounded-lg shadow dark:shadow-gray-800 p-6">
                                    <div class="flex items-center pb-6 border-b border-gray-100 dark:border-gray-800">
                                        ...
                                        <div class="ltr:pl-4 rtl:pr-4">
                                            <a href=""
                                                class="text-lg hover:text-indigo-600 duration-500 ease-in-out">Barbara
                                                McIntosh</a>
                                            <p class="text-slate-400">Student</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-6">
                                        <p class="text-slate-400">There are so many things I had to do with my old software
                            ...
                            <ul class="space-y-4">
                                <li class="rounded-lg shadow dark:shadow-gray-800 p-6">
                                    <div class="flex items-center pb-6 border-b border-gray-100 dark:border-gray-800">
                                        ...
                                        <div class="ltr:pl-4 rtl:pr-4">
                                            <a href="" class="text-lg hover:text-indigo-600 duration-500 ease-in-out">Carl
                                                Oliver</a>
                                            <p class="text-slate-400">Student</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-6">
                                        <p class="text-slate-400">The best part about Techwind is every time I pay my
                                ...
                                <li class="rounded-lg shadow dark:shadow-gray-800 p-6">
                                    <div class="flex items-center pb-6 border-b border-gray-100 dark:border-gray-800">
                                        ...
                                        <div class="ltr:pl-4 rtl:pr-4">
                                            <a href="" class="text-lg hover:text-indigo-600 duration-500 ease-in-out">Jill
                                                Webb</a>
                                            <p class="text-slate-400">Student</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-6">
                                        <p class="text-slate-400">I'm trying to get a hold of someone in support, I'm in a
                        ...
                        <div class="slide h-auto md:w-[360px] w-72 m-2">
                            <ul class="space-y-4">
                                <li class="rounded-lg shadow dark:shadow-gray-800 p-6">
                                    ...
                                    <div class="mt-6">
                                        <p class="text-slate-400">I used to have to remit tax to the EU and with Techwind I
                                ...
                                <li class="rounded-lg shadow dark:shadow-gray-800 p-6">
                                    <div class="flex items-center pb-6 border-b border-gray-100 dark:border-gray-800">
                                        ...
                                        <div class="ltr:pl-4 rtl:pr-4">
                                            <a href=""
                                                class="text-lg hover:text-indigo-600 duration-500 ease-in-out">Janisha
                                                Doll</a>
                                            <p class="text-slate-400">Student</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-6">
                                        <p class="text-slate-400">This is the fourth email I've sent to your support team. I
        ...
        <div class="grid md:grid-cols-12 grid-cols-1 mt-8 gap-[30px]">
            <div class="lg:col-span-3 md:col-span-6">
                <div class="group text-center">
                    <div class="relative inline-block mx-auto h-52 w-52 rounded-full overflow-hidden">
                        ...
                        <ul
                            class="list-none absolute right-0 left-0 -bottom-20 group-hover:bottom-5 transition-all duration-500 ease-in-out">
                    ...
                    <div class="content mt-3">
                        <a href=""
                            class="text-lg font-semibold hover:text-indigo-600 transition-all duration-500 ease-in-out">Jack
                            John</a>
            ...
            <div class="lg:col-span-3 md:col-span-6">
                <div class="group text-center">
                    ...
                    <div class="content mt-3">
                        <a href=""
                            class="text-lg font-semibold hover:text-indigo-600 transition-all duration-500 ease-in-out">Krista
                            John</a>
                        <p class="text-slate-400">Professor</p>
                    </div>
                </div>
            ...
            <div class="lg:col-span-3 md:col-span-6">
                <div class="group text-center">
                    ...
                    <div class="content mt-3">
                        <a href=""
                            class="text-lg font-semibold hover:text-indigo-600 transition-all duration-500 ease-in-out">Roger
                            Jackson</a>
                        <p class="text-slate-400">Professor</p>
                    </div>
                </div>
            ...
            <div class="lg:col-span-3 md:col-span-6">
                <div class="group text-center">
                    ...
                    <div class="content mt-3">
                        <a href=""
                            class="text-lg font-semibold hover:text-indigo-600 transition-all duration-500 ease-in-out">Johnny
                            English</a>
                        <p class="text-slate-400">Professor</p>
                    </div>
                </div>
