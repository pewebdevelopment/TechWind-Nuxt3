        ...
        <div class="container">
            <div class="relative grid md:grid-cols-12 grid-cols-1 items-center mt-10 gap-[30px]">
                <div class="md:col-span-6">
                    <div class="ltr:md:mr-8 rtl:md:ml-8">
                        <h4 class="font-bold lg:leading-normal leading-normal text-4xl lg:text-5xl mb-5 text-black dark:text-white relative">Easy way to <span class="before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-indigo-600 relative inline-block"><span class="relative text-white">manage</span></span> your over work</h4>
                        ...
                        <div class="subcribe-form mt-6 mb-3">
                            <form class="relative max-w-xl">
                                ...
                                <button type="submit" class="btn absolute top-[2px] ltr:right-[3px] rtl:left-[3px] h-[46px] bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-full">Try it for free <i class="uil uil-arrow-right"></i></button>
                            </form><!--end form-->
                        </div>
                ...
                <div class="md:col-span-6">
                    <div class="relative">
                        ...
                        <div class="absolute flex justify-between items-center md:bottom-10 bottom-5 ltr:md:-left-16 rtl:md:-right-16 p-4 rounded-lg shadow-md dark:shadow-gray-800 bg-white dark:bg-slate-900 w-60 m-3">
                            <div class="flex items-center">
                                <div class="flex items-center justify-center h-[65px] min-w-[65px] bg-indigo-600/5 text-indigo-600 text-center rounded-full ltr:mr-3 rtl:ml-3">
                        ...
                        <div class="absolute xl:top-20 top-40 ltr:xl:-right-20 rtl:xl:-left-20 ltr:lg:-right-10 rtl:lg:-left-10 ltr:-right-1 rtl:-left-1 p-4 rounded-lg shadow-md dark:shadow-gray-800 bg-white dark:bg-slate-900 w-60 m-3">
    ...
    <section class="relative md:pb-24 pb-16 overflow-hidden">
        <div class="container lg mx-auto">
            <div class="grid grid-cols-1 pb-8 text-center">
                <div class="flex items-center justify-center rounded-full mx-auto bg-gray-50 dark:bg-slate-800 shadow dark:shadow-gray-800 w-[110px] h-[110px]">
                    <img src=@/assets/images/logo-icon-40.png class="block mx-auto" alt="">
                </div>
                <h3 class="mb-6 mt-8 md:text-4xl text-3xl md:leading-normal leading-normal font-bold">The best customer relationship <br> management platform for just <br> about <span class="after:absolute ltr:after:right-0 rtl:after:left-0  ltr:after:left-0 rtl:after:right-0  after:bottom-1 after:lg:h-3 after:h-2 after:w-auto after:rounded-md after:bg-indigo-600/30 relative text-indigo-600">everything.</span></h3>
        ...
        <div class="container md:mt-24 mt-16">
            ...
            <div class="grid md:grid-cols-2 grid-cols-1 items-center mt-16 gap-[30px]">
                <div class="relative">
                    ...
                    <div class="overflow-hidden absolute lg:h-[400px] h-[320px] lg:w-[400px] w-[320px] bg-indigo-600/5 dark:bg-indigo-600/20 bottom-0 ltr:left-0 rtl:right-0 rotate-45 -z-1 rounded-3xl"></div>
                </div>
        ...
        <div class="container md:mt-24 mt-16">
            <div class="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                <div class="relative order-1 md:order-2">
                    ...
                    <div class="overflow-hidden absolute lg:h-[400px] h-[320px] lg:w-[400px] w-[320px] bg-indigo-600/5 dark:bg-indigo-600/20 bottom-0 ltr:right-0 rtl:left-0 rotate-45 -z-1 rounded-3xl"></div>
                </div>
            ...
            <div class="grid lg:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                <div class="lg:col-span-5">
                    <div class="ltr:lg:text-left rtl:lg:text-right text-center">
                        ...
                        <div class="mt-6">
                            <a href="page-pricing.html" class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md ltr:mr-2 rtl:ml-2 mt-2"><i class="uil uil-master-card"></i> Subscribe Now</a>
                        </div>
                    </div>
                </div><!--end col-->
                                ...
                                <div class="p-6 py-8">
                                   ...
                                   <div class="flex mb-5">
                                    ...
                                    <ul class="list-none text-slate-400">
                                        <li class="mb-1 flex"><i class="uil uil-check-circle text-indigo-600 text-xl ltr:mr-2 rtl:ml-2"></i> Full Access</li>
                                        <li class="mb-1 flex"><i class="uil uil-check-circle text-indigo-600 text-xl ltr:mr-2 rtl:ml-2"></i> Source Files</li>
                                        <li class="mb-1 flex"><i class="uil uil-check-circle text-indigo-600 text-xl ltr:mr-2 rtl:ml-2"></i> Free Appointments</li>
                                        <li class="mb-1 flex"><i class="uil uil-check-circle text-indigo-600 text-xl ltr:mr-2 rtl:ml-2"></i> Enhanced Security</li>
                                    </ul>
        ...
        <div class="container md:mt-24 mt-16">
            ...
            <div class="relative grid md:grid-cols-12 grid-cols-1 items-center mt-8 gap-[30px]">
                <div class="md:col-span-6">
                    <div class="relative">
                        <div class="relative rounded-xl overflow-hidden shadow-md dark:shadow-gray-800">
                            <div class="w-full py-72 bg-slate-400 bg-[url('../../assets/images/saas/cta.jpg')] bg-no-repeat bg-top bg-cover jarallax" data-jarallax data-speed="0.5"></div>
                        </div>
                    </div>
                </div><!--end col-->
