<template>
            ...
            <ul class="circles p-0 mb-0">
                ...
                <li class="brand-img"><img src="@/assets/images/client/facebook-logo-2019.png" class="w-9 h-9" alt=""></li>
        ...
        <div class="relative">
            <div class="absolute block w-full h-auto bottom-[25px] z-1 left-0">
                <a href=""><i class="mdi mdi-arrow-down absolute top-0 left-0 right-0 text-center inline-flex items-center justify-center rounded-full bg-white dark:bg-slate-900 h-12 w-12 mx-auto shadow-md dark:shadow-gray-800"></i></a>
            </div>
                ...
                <div class="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                    ...
                    <div class="lg:col-span-7 md:col-span-6">
                        <div class="ltr:lg:ml-5 rtl:lg:mr-5">
                            ...
                            <div class="mt-6">
                                <a href="" class="btn btn-link text-indigo-600 hover:text-indigo-600 after:bg-indigo-600 duration-500 ease-in-out">Read More <i class="uil uil-arrow-right align-middle"></i></a>
                            </div>
                        </div>
                    </div>
                </div><!--end grid-->
            ...
            <div class="container mt-12">
                <div class="grid grid-cols-2 md:grid-cols-4">
                    ...
                    <div class="counter-box relative text-center">
                        ...
                        <span class="counter-head font-semibold text-xl absolute top-2/4 left-0 right-0">Years of Experience</span>
                    </div><!--end counter box-->

                    <div class="counter-box relative text-center">
                        <h3 class="font-extrabold lg:text-[72px] text-[50px] opacity-5"><span class="counter-value" data-target="54">5</span></h3>
                        <span class="counter-head font-semibold text-xl absolute top-2/4 left-0 right-0">Offices in the World</span>
                    </div><!--end counter box-->

                    <div class="counter-box relative text-center">
                        <h3 class="font-extrabold lg:text-[72px] text-[50px] opacity-5"><span class="counter-value" data-target="125">12</span>K</h3>
                        <span class="counter-head font-semibold text-xl absolute top-2/4 left-0 right-0">No. of Job Positions</span>
                    </div><!--end counter box-->
                </div><!--end grid-->
            </div><!--end container-->
        </section><!--end section-->
        ...
        <section class="relative md:py-24 py-16">
            <div class="container">
                ...
                <div class="grid md:grid-cols-12 grid-cols-1 mt-8">
                    <div class="md:col-span-12 text-center">
                        <a href="page-job-grid.html" class="btn btn-link text-slate-400 hover:text-indigo-600 after:bg-indigo-600 duration-500 ease-in-out">See More Jobs <i class="uil uil-arrow-right align-middle"></i></a>
                    </div>
                </div><!--end grid-->
            </div><!--end container-->
