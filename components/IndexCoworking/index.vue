<template>
    <section class="relative md:py-60 py-36 items-center">
        <div class="absolute top-0 left-0 w-full h-full z-0 pointer-events-none overflow-hidden">
            <!-- <iframe src="https://player.vimeo.com/video/33955001?background=1&autoplay=1&loop=1&byline=0&title=0" class="absolute top-1/2 ltr:left-1/2 ltr:-translate-x-1/2 rtl:right-1/2 rtl:translate-x-1/2  -translate-y-1/2 w-screen h-[56.25vw] min-h-screen min-w-[177.77vw]"></iframe> -->
            ...
            <iframe src="https://www.youtube.com/embed/JsNvHJsufhI?controls=0&showinfo=0&rel=0&autoplay=1&loop=1&mute=1"
                class="absolute top-1/2 ltr:left-1/2 ltr:-translate-x-1/2 rtl:right-1/2 rtl:translate-x-1/2  -translate-y-1/2 w-screen h-[56.25vw] min-h-screen min-w-[177.77vw]"></iframe>
            <!--Note: Youtube Embed Background Video-->
        </div>
        <div class="absolute inset-0 opacity-20 bg-[url('../../@/assets/images/map.svg')] bg-no-repeat bg-center bg-cover">
        </div>
        ...
        <div class="container">
            <div class="grid grid-cols-1 pb-8 text-center mt-10">
                ...
                <h3 class="font-bold lg:leading-normal leading-normal text-4xl lg:text-5xl mb-5 mt-10 text-white">Coworking
                    Just Feels Right</h3>

                <p class="text-slate-300 text-lg max-w-2xl mx-auto">Coworking spaces offer a wealth of advantages for self
                    starters, including networking opportunities, daily structure, and increased productivity.</p>

                <div class="subcribe-form z-1 mt-8">
                    <form class="relative mx-auto max-w-xl">
                        <i data-feather="map-pin"
                            class="w-5 h-5 absolute top-[48%] -translate-y-1/2 ltr:left-4 rtl:right-4"></i>
                        <input type="text" id="search_name" name="name"
                            class="pt-4 ltr:pr-4 rtl:pl-40 pb-4 w-full h-[50px] outline-none text-black dark:text-white rounded-full bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 ltr:pl-12 rtl:pr-12"
                            placeholder="Washington, D.C.">
                        <button type="submit"
                            class="btn absolute top-[2px] ltr:right-[3px] rtl:left-[3px] h-[46px] bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-full">Find
                            A Space</button>
                    </form><!--end form-->
                </div>
            </div><!--end grid-->
    ...
    <section class="relative md:py-24 py-16">
            ...
            <div class="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                ...
                <div class="md:col-span-6 mt-8 md:mt-0">
                    <div class="ltr:lg:mr-5 rtl:lg:ml-5">
                        ...
                        <h3 class="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">“Sweet as the
                            Moment When <br> the coworking Went 'Pop”</h3>
                        ...
                        <a href=""
                            class="btn bg-indigo-600/5 hover:bg-indigo-600 border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white rounded-full">Get
                            Started</a>
                    </div>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-4 gap-[30px]">
                ...
                <div
                    ...
                    <div class="relative overflow-hidden text-transparent -m-3">
                        ...
                        <div
                            class="absolute top-2/4 -translate-y-2/4 left-0 right-0 mx-auto text-indigo-600 rounded-xl transition-all duration-500 ease-in-out text-3xl flex align-middle justify-center items-center">
                    ...
                    <div class="mt-6">
                        <a href=""
                            class="text-xl font-medium transition-all duration-500 ease-in-out hover:text-indigo-600">Free
                            Internet</a>
                ...
                <div
                    ...
                    <div class="mt-6">
                        <a href=""
                            class="text-xl font-medium transition-all duration-500 ease-in-out hover:text-indigo-600">Group
                            Events</a>
                        <p class="text-slate-400 transition-all duration-500 ease-in-out mt-3">If the distribution of
                            letters and 'words' is random, the reader will not be distracted from making.</p>
                    </div>
                ...
                <div
                    ...
                    <div class="mt-6">
                        <a href=""
                            class="text-xl font-medium transition-all duration-500 ease-in-out hover:text-indigo-600">Meeting
                            Room</a>
                        <p class="text-slate-400 transition-all duration-500 ease-in-out mt-3">If the distribution of
                            letters and 'words' is random, the reader will not be distracted from making.</p>
                    </div>
                ...
                <div
                    ...
                    <div class="mt-6">
                        <a href=""
                            class="text-xl font-medium transition-all duration-500 ease-in-out hover:text-indigo-600">Coffee
                            & Tea</a>
                        <p class="text-slate-400 transition-all duration-500 ease-in-out mt-3">If the distribution of
                            letters and 'words' is random, the reader will not be distracted from making.</p>
                    </div>
                ...
                <div
                    ...
                    <div class="mt-6">
                        <a href=""
                            class="text-xl font-medium transition-all duration-500 ease-in-out hover:text-indigo-600">Relax
                            Room</a>
                        <p class="text-slate-400 transition-all duration-500 ease-in-out mt-3">If the distribution of
                            letters and 'words' is random, the reader will not be distracted from making.</p>
                    </div>
        ...
        <div class="container md:mt-24 mt-16">
            <div class="grid grid-cols-1 pb-8 text-center">
                <h3 class="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">We provide Different
                    types of office</h3>
                    ...
                    <div class="tiny-six-item">
                        <div class="tiny-slide">
                            <div class="group relative rounded-md shadow dark:shadow-gray-800 overflow-hidden mx-2">
                                <div class="relative">
                                    <img src="@/assets/images/cowork/1.jpg"
                                        class="group-hover:rotate-3 group-hover:scale-110 duration-500 ease-in-out" alt="">
                                    <div class="absolute inset-0 bg-gradient-to-t from-black"></div>
                                </div>

                                <div class="absolute bottom-6 right-6 left-6">
                                    <a href=""
                                        class="text-white/70 hover:text-white text-lg block font-semibold duration-500 ease-in-out">Private
                                        Office</a>
                                    <span class="text-white/60 block">Co-space</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tiny-slide">
                            <div class="group relative rounded-md shadow dark:shadow-gray-800 overflow-hidden mx-2">
                                <div class="relative">
                                    <img src="@/assets/images/cowork/2.jpg"
                                        class="group-hover:rotate-3 group-hover:scale-110 duration-500 ease-in-out" alt="">
                                    <div class="absolute inset-0 bg-gradient-to-t from-black"></div>
                                </div>
                                ...
                                <div class="absolute bottom-6 right-6 left-6">
                                    <a href=""
                                        class="text-white/70 hover:text-white text-lg block font-semibold duration-500 ease-in-out">Dedicated
                                        Space</a>
                                    <span class="text-white/60 block">Co-space</span>
                                </div>
                            </div>
                        ...
                        <div class="tiny-slide">
                            <div class="group relative rounded-md shadow dark:shadow-gray-800 overflow-hidden mx-2">
                                <div class="relative">
                                    <img src="@/assets/images/cowork/3.jpg"
                                        class="group-hover:rotate-3 group-hover:scale-110 duration-500 ease-in-out" alt="">
                                    <div class="absolute inset-0 bg-gradient-to-t from-black"></div>
                                </div>
                                ...
                                <div class="absolute bottom-6 right-6 left-6">
                                    <a href=""
                                        class="text-white/70 hover:text-white text-lg block font-semibold duration-500 ease-in-out">Small
                                        Office</a>
                                    <span class="text-white/60 block">Co-space</span>
                                </div>
                            </div>
                        ...
                        <div class="tiny-slide">
                            <div class="group relative rounded-md shadow dark:shadow-gray-800 overflow-hidden mx-2">
                                <div class="relative">
                                    <img src="@/assets/images/cowork/4.jpg"
                                        class="group-hover:rotate-3 group-hover:scale-110 duration-500 ease-in-out" alt="">
                                    <div class="absolute inset-0 bg-gradient-to-t from-black"></div>
                                </div>
                                ...
                                <div class="absolute bottom-6 right-6 left-6">
                                    <a href=""
                                        class="text-white/70 hover:text-white text-lg block font-semibold duration-500 ease-in-out">Floating
                                        Seat</a>
                                    <span class="text-white/60 block">Co-space</span>
                                </div>
                            </div>
                        ...
                        <div class="tiny-slide">
                            <div class="group relative rounded-md shadow dark:shadow-gray-800 overflow-hidden mx-2">
                                <div class="relative">
                                    <img src="@/assets/images/cowork/5.jpg"
                                        class="group-hover:rotate-3 group-hover:scale-110 duration-500 ease-in-out" alt="">
                                    <div class="absolute inset-0 bg-gradient-to-t from-black"></div>
                                </div>
                                ...
                                <div class="absolute bottom-6 right-6 left-6">
                                    <a href=""
                                        class="text-white/70 hover:text-white text-lg block font-semibold duration-500 ease-in-out">Startups
                                        Desk</a>
                                    <span class="text-white/60 block">Co-space</span>
                                </div>
                            </div>
                        ...
                        <div class="tiny-slide">
                            <div class="group relative rounded-md shadow dark:shadow-gray-800 overflow-hidden mx-2">
                                <div class="relative">
                                    <img src="@/assets/images/cowork/6.jpg"
                                        class="group-hover:rotate-3 group-hover:scale-110 duration-500 ease-in-out" alt="">
                                    <div class="absolute inset-0 bg-gradient-to-t from-black"></div>
                                </div>
                                ...
                                <div class="absolute bottom-6 right-6 left-6">
                                    <a href=""
                                        class="text-white/70 hover:text-white text-lg block font-semibold duration-500 ease-in-out">Retail
                                        Space</a>
                                    <span class="text-white/60 block">Co-space</span>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="grid grid-cols-1 justify-center">
                <div class="relative z-1">
                    <div
                        class="grid lg:grid-cols-12 grid-cols-1 ltr:md:text-left rtl:md:text-right text-center justify-center">
    ...
    <section class="realtive md:py-24 py-16">
                        ...
                        <ul class="flex-column text-center p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 rounded-md"
                            ...
                            <li role="presentation">
                                <button
                                    ...
                                    aria-controls="profile" aria-selected="true">Private Office</button>
                            </li>
                            <li role="presentation">
                                <button
                                    class="px-4 py-2 text-base font-semibold rounded-md w-full mt-3 transition-all duration-500 ease-in-out"
                                    id="dashboard-tab" data-tabs-target="#dashboard" type="button" role="tab"
                                    aria-controls="dashboard" aria-selected="false">Dedicated Office</button>
                            </li>
                            <li role="presentation">
                                <button
                                    class="px-4 py-2 text-base font-semibold rounded-md w-full mt-3 transition-all duration-500 ease-in-out"
                                    id="settings-tab" data-tabs-target="#settings" type="button" role="tab"
                                    aria-controls="settings" aria-selected="false">Kitchen Space</button>
                            </li>
                            <li role="presentation">
                                <button
                                    class="px-4 py-2 text-base font-semibold rounded-md w-full mt-3 transition-all duration-500 ease-in-out"
                                    id="contacts-tab" data-tabs-target="#contacts" type="button" role="tab"
                                    aria-controls="contacts" aria-selected="false">Meeting Rooms</button>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container md:mt-24 mt-16">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 mt-8 gap-[30px]">
                ...
                <div class="content p-6">
                    <a href="blog-detail.html"
                        class="title h5 text-lg font-medium hover:text-indigo-600 duration-500 ease-in-out">Tips for
            ...
            <div class="blog relative rounded-md shadow dark:shadow-gray-800 overflow-hidden">
                ...
                <div class="content p-6">
                    <a href="blog-detail.html"
                        class="title h5 text-lg font-medium hover:text-indigo-600 duration-500 ease-in-out">Green work
                        environment</a>
                    <p class="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and benefit
                    </p>
            ...
            <div class="blog relative rounded-md shadow dark:shadow-gray-800 overflow-hidden">
                ...
                <div class="content p-6">
                    <a href="blog-detail.html"
                        class="title h5 text-lg font-medium hover:text-indigo-600 duration-500 ease-in-out">Importance
                        of social interactions</a>
                    <p class="text-slate-400 mt-3">The phrasal sequence of the is now so that many campaign and benefit
                    </p>
...
<div class="container-fluid relative">
    <div class="grid grid-cols-1">
        ...
        <div class="absolute top-1/2 -translate-y-1/2 left-0 right-0 text-center">
            <a href="#!" data-modal-toggle="contactModal"
                class="btn btn-icon btn-lg bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-full"><i
                    class="uil uil-phone"></i></a>
        </div>
    </div><!--end grid-->
</div><!--end container-->
    ...
    <div class="relative w-full h-auto max-w-md p-4">
        <div class="relative bg-white dark:bg-slate-900 rounded-lg shadow dark:shadow-gray-800">
            <div class="flex justify-between items-center px-6 py-4 border-b border-gray-100 dark:border-gray-700">
                ...
                <button type="button"
                    class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ltr:ml-auto rtl:mr-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
                        ...
                        <div class="lg:col-span-6 mb-5">
                            <div class="ltr:text-left rtl:text-right">
                                ...
                                <div class="form-icon relative mt-2">
                                    ...
                                    <input name="name" id="name" type="text" class="form-input ltr:pl-11 rtl:pr-11"
                                        placeholder="Name :">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="lg:col-span-6 mb-5">
                            <div class="ltr:text-left rtl:text-right">
                                ...
                                <div class="form-icon relative mt-2">
                                    ...
                                    <input name="email" id="email" type="email" class="form-input ltr:pl-11 rtl:pr-11"
                                        placeholder="Email :">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1">
                        <div class="mb-5">
                            <div class="ltr:text-left rtl:text-right">
                                ...
                                <div class="form-icon relative mt-2">
                                    <i data-feather="book" class="w-4 h-4 absolute top-3 ltr:left-4 rtl:right-4"></i>
                                    <input name="subject" id="subject" class="form-input ltr:pl-11 rtl:pr-11"
                                        placeholder="Subject :">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-5">
                            <div class="ltr:text-left rtl:text-right">
                                ...
                                <div class="form-icon relative mt-2">
                                    ...
                                    <textarea name="comments" id="comments" class="form-input ltr:pl-11 rtl:pr-11 h-28"
