<template>
    <section
        class="relative table w-full py-36 lg:py-64 bg-[url('../../@/assets/images/event/bg.jpg')] bg-no-repeat bg-center bg-cover">
        ...
        <div class="container">
            <div class="grid md:grid-cols-12 grid-cols-1 items-center mt-10 gap-[30px]">
                <div class="lg:col-span-8 md:col-span-7 md:order-1 order-2">
                    ...
                    <h4 class="font-bold lg:leading-normal leading-normal text-4xl lg:text-5xl mb-5 text-white">Join Our
                        <br> Web Design Seminar</h4>
                    <p class="text-white/60 text-lg max-w-xl">Launch your campaign and benefit from our expertise on
                        designing and managing conversion centered Tailwind CSS v3.x html page.</p>

                    <div class="mt-8">
                        <a href="#ticket"
                            class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md"><i
                                class="uil uil-envelope"></i> Buy Ticket</a>
                    </div>
                </div>

                <div class="lg:col-span-4 md:col-span-5 md:text-center md:order-2 order-1">
                    <a href="#!" data-type="youtube" data-id="yba7hPeTSjk"
                        class="lightbox lg:h-24 h-20 lg:w-24 w-20 rounded-full shadow-lg dark:shadow-gray-800 inline-flex items-center justify-center bg-white hover:bg-indigo-600 text-indigo-600 hover:text-white duration-500 ease-in-out mx-auto">
            ...
            <div class="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                ...
                <div class="md:col-span-6 mt-8 md:mt-0">
                    <div class="ltr:lg:ml-5 rtl:lg:mr-5">
                        ...
                        <h3 class="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">Get access to
                            the full <br> conference experience.</h3>
                        ...
                        <div class="flex mt-6">
                            <i class="uil uil-map-marker text-indigo-600 text-4xl ltr:mr-4 rtl:ml-4 mt-2"></i>
                            <div class="">
                                <h5 class="text-xl font-semibold mb-0">Location</h5>
                                <p class="text-slate-400 mt-2">C/54 Northwest Freeway, <br> Suite 558, Houston, <br> USA 485
                                </p>
                            </div>
                        </div>

                        <div class="flex mt-6">
                            <i class="uil uil-clock text-indigo-600 text-4xl ltr:mr-4 rtl:ml-4 mt-2"></i>
                            <div class="">
    ...
    <!-- Start CTA -->
    <section
        class="relative table w-full py-36 bg-[url('../../@/assets/images/event/bg3.jpg')] bg-no-repeat bg-bottom bg-cover">
        <div class="absolute inset-0 bg-gradient-to-t from-indigo-600/90 to-fuchsia-600/90"></div>
        <div class="container">
            <div class="grid grid-cols-1 text-center">
                <div class="pb-8">
                    <h6 class="text-white/50 text-sm font-bold uppercase mb-2">Hurry up & Register</h6>
                    <h3 class="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold text-white">Not yet
                        registered? <br> Hurry up!</h3>

                    <p class="text-white/50 max-w-xl mx-auto">Start working with Tailwind CSS that can provide everything
    ...
    <section class="relative md:py-24 py-16">
        <div class="container">
            ...
            <div class="grid grid-cols-1 mt-8">
                <ul class="md:w-fit w-full mx-auto flex-wrap justify-center text-center p-3 bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 rounded-md"
                    id="myTab" data-tabs-toggle="#StarterContent" role="tablist">
                    <li role="presentation" class="md:inline-block block md:w-fit w-full">
                        <button
                            class="px-6 py-2 font-semibold rounded-md w-full hover:text-indigo-600 transition-all duration-500 ease-in-out"
                            id="tuesday-tab" data-tabs-target="#tuesday" type="button" role="tab" aria-controls="tuesday"
                            aria-selected="true">Tuesday</button>
                    </li>
                    <li role="presentation" class="md:inline-block block md:w-fit w-full">
                        <button class="px-6 py-2 font-semibold rounded-md w-full transition-all duration-500 ease-in-out"
                            id="wednesday-tab" data-tabs-target="#wednesday" type="button" role="tab"
                            aria-controls="wednesday" aria-selected="false">Wednesday</button>
                    </li>
                    <li role="presentation" class="md:inline-block block md:w-fit w-full">
                        <button class="px-6 py-2 font-semibold rounded-md w-full transition-all duration-500 ease-in-out"
                            id="thursday-tab" data-tabs-target="#thursday" type="button" role="tab" aria-controls="thursday"
                            aria-selected="false">Thursday</button>
                    </li>
                    <li role="presentation" class="md:inline-block block md:w-fit w-full">
                        <button class="px-6 py-2 font-semibold rounded-md w-full transition-all duration-500 ease-in-out"
                            id="friday-tab" data-tabs-target="#friday" type="button" role="tab" aria-controls="friday"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td
                                                ...
                                                <div class="flex items-center">
                                                    <img src="@/assets/images/event/eve-sch/1.jpg"
                                                        class="rounded-full h-24 w-24 shadow-md dark:shadow-gray-700"
                                                        alt="">

                                                    <div class="ltr:ml-4 rtl:mr-4">
                                                        <a href=""
                                                            class="hover:text-indigo-600 text-lg font-semibold">Digital
                                                            Conference Event Intro</a>
                                                        <p class="text-slate-400 mt-2">The most well-known dummy text is the
                                                            'Lorem Ipsum', which is said to have originated in the 16th
                                                            century</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td
                                                ...
                                                <span class="block text-black dark:text-white text-md mt-1">Raymond
                                                    Turner</span>
                                            </td>
                                            <td
                                                class="ltr:text-right rtl:text-left border-b border-gray-100 dark:border-gray-700 py-12 px-5 min-w-[180px]">
                                                <a href=""
                                                    class="btn btn-link font-medium hover:text-indigo-600 after:bg-indigo-600 duration-500 ease-in-out">Buy
                                        ...
                                        <tr>
                                            ...
                                            <td
                                                class="p-3 border-b border-gray-100 dark:border-gray-700 min-w-[540px] py-12 px-5">
                                                <div class="flex items-center">
                                                    <img src="@/assets/images/event/eve-sch/2.jpg"
                                                        class="rounded-full h-24 w-24 shadow-md dark:shadow-gray-700"
                                                        alt="">

                                                    <div class="ltr:ml-4 rtl:mr-4">
                                                        <a href=""
                                                            class="hover:text-indigo-600 text-lg font-semibold">Conference
                                                            On User Interface</a>
                                                        <p class="text-slate-400 mt-2">The most well-known dummy text is the
                                                            'Lorem Ipsum', which is said to have originated in the 16th
                                                            century</p>
                                            ...
                                            <td
                                                class="text-center border-b border-gray-100 dark:border-gray-700 py-12 px-5 min-w-[180px] text-slate-400">
                                                <span class="block">Speaker</span>
                                                <span class="block text-black dark:text-white text-md mt-1">Cindy
                                                    Morrison</span>
                                            </td>
                                            <td
                                                class="ltr:text-right rtl:text-left border-b border-gray-100 dark:border-gray-700 py-12 px-5 min-w-[180px]">
                                        ...
                                        <tr>
                                            ...
                                            <td
                                                class="p-3 border-b border-gray-100 dark:border-gray-700 min-w-[540px] py-12 px-5">
                                                <div class="flex items-center">
                                                    <img src="@/assets/images/event/eve-sch/3.jpg"
                                                        class="rounded-full h-24 w-24 shadow-md dark:shadow-gray-700"
                                                        alt="">

                                                    <div class="ltr:ml-4 rtl:mr-4">
                                                        <a href=""
                                                            class="hover:text-indigo-600 text-lg font-semibold">Business
                                                            World Event Intro</a>
                                                        <p class="text-slate-400 mt-2">The most well-known dummy text is the
                                                            'Lorem Ipsum', which is said to have originated in the 16th
                                                            century</p>
                                            ...
                                            <td
                                                class="text-center border-b border-gray-100 dark:border-gray-700 py-12 px-5 min-w-[180px] text-slate-400">
                                                <span class="block">Speaker</span>
                                                <span class="block text-black dark:text-white text-md mt-1">Vincent
                                                    Adams</span>
                                            </td>
                                            <td
                                                class="ltr:text-right rtl:text-left border-b border-gray-100 dark:border-gray-700 py-12 px-5 min-w-[180px]">
                                        ...
                                        <tr>
                                            ...
                                            <td
                                                class="p-3 border-b border-gray-100 dark:border-gray-700 min-w-[540px] py-12 px-5">
                                                <div class="flex items-center">
                                                    <img src="@/assets/images/event/eve-sch/4.jpg"
                                                        class="rounded-full h-24 w-24 shadow-md dark:shadow-gray-700"
                                                        alt="">
                                            ...
                                            <td
                                                class="text-center border-b border-gray-100 dark:border-gray-700 py-12 px-5 min-w-[180px] text-slate-400">
                                                <span class="block">Speaker</span>
                                                <span class="block text-black dark:text-white text-md mt-1">Ana
                                                    Heweit</span>
                                            </td>
                                            <td
                                                class="ltr:text-right rtl:text-left border-b border-gray-100 dark:border-gray-700 py-12 px-5 min-w-[180px]">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td
                                                class="p-3 border-b border-gray-100 dark:border-gray-700 min-w-[540px] py-12 px-5">
                                                <div class="flex items-center">
                                                    <img src="@/assets/images/event/eve-sch/5.jpg"
                                                        class="rounded-full h-24 w-24 shadow-md dark:shadow-gray-700"
                                                        alt="">
                                        ...
                                        <tr>
                                            ...
                                            <td
                                                class="p-3 border-b border-gray-100 dark:border-gray-700 min-w-[540px] py-12 px-5">
                                                <div class="flex items-center">
                                                    <img src="@/assets/images/event/eve-sch/6.jpg"
                                                        class="rounded-full h-24 w-24 shadow-md dark:shadow-gray-700"
                                                        alt="">
                                        ...
                                        <tr>
                                            ...
                                            <td
                                                class="p-3 border-b border-gray-100 dark:border-gray-700 min-w-[540px] py-12 px-5">
                                                <div class="flex items-center">
                                                    <img src="@/assets/images/event/eve-sch/7.jpg"
                                                        class="rounded-full h-24 w-24 shadow-md dark:shadow-gray-700"
                                                        alt="">
                                        ...
                                        <tr>
                                            ...
                                            <td
                                                class="p-3 border-b border-gray-100 dark:border-gray-700 min-w-[540px] py-12 px-5">
                                                <div class="flex items-center">
                                                    <img src="@/assets/images/event/eve-sch/8.jpg"
                                                        class="rounded-full h-24 w-24 shadow-md dark:shadow-gray-700"
                                                        alt="">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td
                                                class="p-3 border-b border-gray-100 dark:border-gray-700 min-w-[540px] py-12 px-5">
                                                <div class="flex items-center">
                                                    <img src="@/assets/images/event/eve-sch/9.jpg"
                                                        class="rounded-full h-24 w-24 shadow-md dark:shadow-gray-700"
                                                        alt="">
                                        ...
                                        <tr>
                                            ...
                                            <td
                                                class="p-3 border-b border-gray-100 dark:border-gray-700 min-w-[540px] py-12 px-5">
                                                <div class="flex items-center">
                                                    <img src="@/assets/images/event/eve-sch/10.jpg"
                                                        class="rounded-full h-24 w-24 shadow-md dark:shadow-gray-700"
                                                        alt="">
                                        ...
                                        <tr>
                                            ...
                                            <td
                                                class="p-3 border-b border-gray-100 dark:border-gray-700 min-w-[540px] py-12 px-5">
                                                <div class="flex items-center">
                                                    <img src="@/assets/images/event/eve-sch/11.jpg"
                                                        class="rounded-full h-24 w-24 shadow-md dark:shadow-gray-700"
                                                        alt="">
                                        ...
                                        <tr>
                                            ...
                                            <td
                                                class="p-3 border-b border-gray-100 dark:border-gray-700 min-w-[540px] py-12 px-5">
                                                <div class="flex items-center">
                                                    <img src="@/assets/images/event/eve-sch/12.jpg"
                                                        class="rounded-full h-24 w-24 shadow-md dark:shadow-gray-700"
                                                        alt="">
...
<!-- Start CTA -->
<section
    class="relative table w-full py-36 bg-[url('../../@/assets/images/event/bg2.jpg')] bg-no-repeat bg-center bg-cover">
    <div class="absolute inset-0 bg-gradient-to-t from-indigo-600/90 to-fuchsia-600/90"></div>
    <div class="container">
        <div class="grid grid-cols-1 text-center">
            <a href="#!" data-type="youtube" data-id="yba7hPeTSjk"
                class="lightbox h-20 w-20 rounded-full shadow-lg dark:shadow-gray-800 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-indigo-600 mx-auto mb-12">
                <i class="mdi mdi-play inline-flex items-center justify-center text-2xl"></i>
            </a>

            <h3 class="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold text-white">Let's Make
                Something Together</h3>
        ...
        <div class="grid lg:grid-cols-12 grid-cols-1 items-center gap-[30px]">
            <div class="lg:col-span-5">
                <div class="ltr:lg:text-left rtl:lg:text-right text-center">
                    ...
                    <h3 class="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">This event is
                        for you. <br> Buy tickets now!</h3>
                ...
                <div class="ltr:lg:ml-8 rtl:lg:mr-8">
                    <div class="grid md:grid-cols-2 grid-cols-1 md:gap-0 gap-[30px]">
                            ...
                            <div class="p-6 py-8">
                                ...
                                <ul class="list-none text-slate-400">
                                    <li class="mb-1 flex"><i
                                            class="uil uil-check-circle text-indigo-600 text-xl ltr:mr-2 rtl:ml-2"></i>
                                        Full Access</li>
                                    <li class="mb-1 flex"><i
                                            class="uil uil-check-circle text-indigo-600 text-xl ltr:mr-2 rtl:ml-2"></i>
                                        Source Files</li>
                        ...
                        <div
                            ...
                            <div class="p-6 py-8 ltr:md:pl-10 rtl:md:pr-10">
