                        ...
                        <div class="p-6 rounded-md shadow dark:shadow-gray-800">
                            ...
                            <div id="grid" class="md:flex justify-center mx-auto">
                                <div class="lg:w-1/4 md:w-1/3 p-1 picture-item" data-groups='["branding"]'>
                                    <div class="group relative block overflow-hidden rounded-md shadow dark:shadow-gray-800 transition-all duration-500">
                                        <a href="@/assets/images/portfolio/1.jpg" class="lightbox transition-all duration-500 group-hover:scale-105" title="">
                                            <img src="@/assets/images/portfolio/1.jpg" class="shadow dark:shadow-gray-800" alt="work-image">
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="lg:w-1/4 md:w-1/3 p-1 picture-item" data-groups='["designing"]'>
                                    <div class="group relative block overflow-hidden rounded-md shadow dark:shadow-gray-800 transition-all duration-500">
                                        <a href="@/assets/images/portfolio/10.jpg" class="lightbox transition-all duration-500 group-hover:scale-105" title="">
                                            <img src="@/assets/images/portfolio/10.jpg" class="shadow dark:shadow-gray-800" alt="work-image">
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="lg:w-1/4 md:w-1/3 p-1 picture-item" data-groups='["photography"]'>
                                    <div class="group relative block overflow-hidden rounded-md shadow dark:shadow-gray-800 transition-all duration-500">
                                        <a href="@/assets/images/portfolio/2.jpg" class="lightbox transition-all duration-500 group-hover:scale-105" title="">
                                            <img src="@/assets/images/portfolio/2.jpg" class="shadow dark:shadow-gray-800" alt="work-image">
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="lg:w-1/4 md:w-1/3 p-1 picture-item" data-groups='["branding"]'>
                                    <div class="group relative block overflow-hidden rounded-md shadow dark:shadow-gray-800 transition-all duration-500">
                                        <a href="@/assets/images/portfolio/13.jpg" class="lightbox transition-all duration-500 group-hover:scale-105" title="">
                                            <img src="@/assets/images/portfolio/13.jpg" class="shadow dark:shadow-gray-800" alt="work-image">
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="lg:w-1/4 md:w-1/3 p-1 picture-item" data-groups='["branding"]'>
                                    <div class="group relative block overflow-hidden rounded-md shadow dark:shadow-gray-800 transition-all duration-500">
                                        <a href="@/assets/images/portfolio/11.jpg" class="lightbox transition-all duration-500 group-hover:scale-105" title="">
                                            <img src="@/assets/images/portfolio/11.jpg" class="shadow dark:shadow-gray-800" alt="work-image">
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="lg:w-1/4 md:w-1/3 p-1 picture-item" data-groups='["designing"]'>
                                    <div class="group relative block overflow-hidden rounded-md shadow dark:shadow-gray-800 transition-all duration-500">
                                        <a href="@/assets/images/portfolio/12.jpg" class="lightbox transition-all duration-500 group-hover:scale-105" title="">
                                            <img src="@/assets/images/portfolio/12.jpg" class="shadow dark:shadow-gray-800" alt="work-image">
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="lg:w-1/4 md:w-1/3 p-1 picture-item" data-groups='["development"]'>
                                    <div class="group relative block overflow-hidden rounded-md shadow dark:shadow-gray-800 transition-all duration-500">
                                        <a href="@/assets/images/portfolio/4.jpg" class="lightbox transition-all duration-500 group-hover:scale-105" title="">
                                            <img src="@/assets/images/portfolio/4.jpg" class="shadow dark:shadow-gray-800" alt="work-image">
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="lg:w-1/4 md:w-1/3 p-1 picture-item" data-groups='["development"]'>
                                    <div class="group relative block overflow-hidden rounded-md shadow dark:shadow-gray-800 transition-all duration-500">
                                        <a href="@/assets/images/portfolio/3.jpg" class="lightbox transition-all duration-500 group-hover:scale-105" title="">
                                            <img src="@/assets/images/portfolio/3.jpg" class="shadow dark:shadow-gray-800" alt="work-image">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-6">
                                ...
                                <p class="text-slate-400 italic border-x-4 border-indigo-600 ltr:rounded-tl-xl rtl:rounded-tr-xl ltr:rounded-br-xl rtl:rounded-bl-xl mt-3 p-3">" There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. "</p>
