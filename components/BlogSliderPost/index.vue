                        ...
                        <div class="p-6 rounded-md shadow dark:shadow-gray-800">
                            <div class="relative">
                                <div class="tiny-single-item">
                                    <div class="tiny-slide"><img src="@/assets/images/blog/01.jpg" class="rounded-md" alt=""></div>
                                    <div class="tiny-slide"><img src="@/assets/images/blog/02.jpg" class="rounded-md" alt=""></div>
                                    <div class="tiny-slide"><img src="@/assets/images/blog/03.jpg" class="rounded-md" alt=""></div>
                                </div>
                            </div>
