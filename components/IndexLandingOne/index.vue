                    ...
                    <div class="mt-6">
                        <div class="subcribe-form mt-6 mb-3">
                            <form class="relative mx-auto max-w-xl">
                                ...
                                <button type="submit" class="btn absolute top-[2px] ltr:right-[3px] rtl:left-[3px] h-[46px] bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-full">Get Started <i class="uil uil-arrow-right"></i></button>
                            </form><!--end form-->
                        </div>
                    </div>
                </div><!--end grid-->
        ...
        <section class="relative md:py-24 py-16">
            ...
            <div class="container md:mt-24 mt-16">
                <div class="grid md:grid-cols-12 grid-cols-1 pb-8 items-center">
                    <div class="md:col-span-6 ltr:md:text-left rtl:md:text-right text-center">
                ...
                <div class="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                    <div class="group rounded-md shadow bg-white dark:bg-slate-900">
                        ...
                        <div class="p-6">
                            ...
                            <ul class="list-none text-slate-400">
                                <li class="mb-1 flex"><span class="text-emerald-600 h5"><i class="uil uil-check-circle text-xl ltr:mr-2 rtl:ml-2"></i></span> 1 Domains</li>
                                <li class="mb-1 flex"><span class="text-emerald-600 h5"><i class="uil uil-check-circle text-xl ltr:mr-2 rtl:ml-2"></i></span> 1 GB File upload </li>
                                <li class="mb-1 flex"><span class="text-emerald-600 h5"><i class="uil uil-check-circle text-xl ltr:mr-2 rtl:ml-2"></i></span> 2 GB Secure storage </li>
                                <li class="mb-1 flex"><span class="text-red-600 h5"><i class="uil uil-times-circle text-xl ltr:mr-2 rtl:ml-2"></i></span> Unlimited bandwidth </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="group rounded-md shadow bg-white dark:bg-slate-900">
                        ...
                        <div class="p-6">
                            <h6 class="mb-3 font-semibold">Features:</h6>
                            <ul class="list-none text-slate-400">
                                <li class="mb-1 flex"><span class="text-emerald-600 h5"><i class="uil uil-check-circle text-xl ltr:mr-2 rtl:ml-2"></i></span> 5 Domains</li>
                                <li class="mb-1 flex"><span class="text-emerald-600 h5"><i class="uil uil-check-circle text-xl ltr:mr-2 rtl:ml-2"></i></span> 2 GB File upload </li>
                                <li class="mb-1 flex"><span class="text-emerald-600 h5"><i class="uil uil-check-circle text-xl ltr:mr-2 rtl:ml-2"></i></span> 20 GB Secure storage </li>
                                <li class="mb-1 flex"><span class="text-red-600 h5"><i class="uil uil-times-circle text-xl ltr:mr-2 rtl:ml-2"></i></span> Unlimited bandwidth </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="group rounded-md shadow bg-white dark:bg-slate-900">
                        ...
                        <div class="p-6">
                            <h6 class="mb-3 font-semibold">Features:</h6>
                            <ul class="list-none text-slate-400">
                                <li class="mb-1 flex"><span class="text-emerald-600 h5"><i class="uil uil-check-circle text-xl ltr:mr-2 rtl:ml-2"></i></span> 10 Domains</li>
                                <li class="mb-1 flex"><span class="text-emerald-600 h5"><i class="uil uil-check-circle text-xl ltr:mr-2 rtl:ml-2"></i></span> 5 GB File upload </li>
                                <li class="mb-1 flex"><span class="text-emerald-600 h5"><i class="uil uil-check-circle text-xl ltr:mr-2 rtl:ml-2"></i></span> 50 GB Secure storage </li>
                                <li class="mb-1 flex"><span class="text-red-600 h5"><i class="uil uil-times-circle text-xl ltr:mr-2 rtl:ml-2"></i></span> Unlimited bandwidth </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="group rounded-md shadow bg-white dark:bg-slate-900">
                        ...
                        <div class="p-6">
                            <h6 class="mb-3 font-semibold">Features:</h6>
                            <ul class="list-none text-slate-400">
                                <li class="mb-1 flex"><span class="text-emerald-600 h5"><i class="uil uil-check-circle text-xl ltr:mr-2 rtl:ml-2"></i></span> 50 Domains</li>
                                <li class="mb-1 flex"><span class="text-emerald-600 h5"><i class="uil uil-check-circle text-xl ltr:mr-2 rtl:ml-2"></i></span> 10 GB File upload </li>
                                <li class="mb-1 flex"><span class="text-emerald-600 h5"><i class="uil uil-check-circle text-xl ltr:mr-2 rtl:ml-2"></i></span> 200 GB Secure storage </li>
                                <li class="mb-1 flex"><span class="text-emerald-600 h5"><i class="uil uil-check-circle text-xl ltr:mr-2 rtl:ml-2"></i></span> Unlimited bandwidth </li>
                            </ul>
                        </div>
                    </div>
                </div><!--end grid-->
