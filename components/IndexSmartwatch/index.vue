<template>
            <!-- Start Hero -->
            <section class="relative flex items-center py-36 h-screen bg-gray-50 dark:bg-slate-800 jarallax" data-jarallax data-speed="0.5" style="background: url('../../assets/images/smartwatch/hero.png') center no-repeat;">
            <div class="container">
                <div class="grid grid-cols-1 pb-8 mt-10">
                    <div class="grid grid-cols-1 mt-10">
                        ...
                        <div class="mt-8">
                            <a href="page-pricing.html" class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md"><i data-feather="shopping-cart" class="h-4 w-4 inline-block ltr:mr-1 rtl:ml-1 align-middle"></i> Buy Now</a>
                        </div>
                    </div><!--end grid-->
                </div><!--end grid-->
            </div><!--end container-->
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute bottom-16 ltr:right-0 rtl:left-0">
                                ...
                                <div class="absolute bottom-2/4 translate-y-2/4 right-0 left-0 text-center">
                                    <a href="#!" data-type="youtube" data-id="yba7hPeTSjk" class="lightbox h-14 w-14 rounded-full shadow-lg inline-flex items-center justify-center bg-white text-indigo-600">
            ...
            <div class="container md:mt-24 mt-16">
                <div class="grid lg:grid-cols-3 md:grid-cols-3 grid-cols-1 mt-8 gap-[30px]">
                    ...
                    <div class="group relative lg:px-10 transition-all duration-500 ease-in-out rounded-xl bg-white dark:bg-slate-900 overflow-hidden text-center">
                        ...
                        <div class="mt-6">
                            <a href="" class="text-xl font-medium transition-all duration-500 ease-in-out hover:text-indigo-600">Built in GPS</a>
                            <p class="text-slate-400 transition-all duration-500 ease-in-out mt-3">If the distribution of letters and 'words' is random, the reader will not be distracted from making.</p>
                        </div>
                    </div><!--end feature-->
                    ...
                    <div class="group relative lg:px-10 transition-all duration-500 ease-in-out rounded-xl bg-white dark:bg-slate-900 overflow-hidden text-center">
                        ...
                        <div class="mt-6">
                            <a href="" class="text-xl font-medium transition-all duration-500 ease-in-out hover:text-indigo-600">Health Tracking</a>
                            <p class="text-slate-400 transition-all duration-500 ease-in-out mt-3">If the distribution of letters and 'words' is random, the reader will not be distracted from making.</p>
                        </div>
                    </div><!--end feature-->
                </div><!--end grid-->
            ...
            <div class="container md:mt-24 mt-16">
                <div class="grid md:grid-cols-2 grid-cols-1 items-center mt-16 gap-[30px]">
                    <div class="relative">
                        ...
                        <div class="overflow-hidden absolute lg:h-[400px] h-[320px] lg:w-[400px] w-[320px] bg-indigo-600/5 bottom-0 ltr:left-0 rtl:right-0 rotate-45 -z-1 rounded-3xl"></div>
                    </div>
            ...
            <div class="container md:mt-24 mt-16">
                <div class="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                    <div class="relative order-1 md:order-2">
                        ...
                        <div class="overflow-hidden absolute lg:h-[400px] h-[320px] lg:w-[400px] w-[320px] bg-indigo-600/5 bottom-0 ltr:right-0 rtl:left-0 rotate-45 -z-1 rounded-3xl"></div>
                    </div>
        ...
        <!-- Start -->
        <section class="relative flex items-center md:py-72 py-44 jarallax" data-jarallax data-speed="0.5" style="background: url('@/assets/images/smartwatch/bg2.jpg') center no-repeat;"></section>
        <!-- End -->
                    ...
                    <div class="lg:col-span-4 md:col-span-6 lg:order-1 order-2">
                        <div class="grid grid-cols-1 gap-[30px]">
                            <div class="group flex transition-all duration-500 ease-in-out xl:p-3">
                                <div class="flex md:order-2 order-1 align-middle justify-center items-center w-14 h-14 mt-1 bg-indigo-600/5 group-hover:bg-indigo-600 group-hover:text-white border-2 border-indigo-600/20 text-indigo-600 rounded-lg text-2xl shadow-sm dark:shadow-gray-800 transition-all duration-500 ease-in-out">
                                    <i data-feather="monitor" class="w-5 h-5"></i>
                                </div>
                                <div class="flex-1 md:order-1 order-2 ltr:md:text-right rtl:md:text-left ltr:md:mr-4 rtl:md:ml-4 ltr:md:ml-0 rtl:md:mr-0 ltr:ml-4 rtl:mr-4">
                                    <h4 class="mb-0 text-lg font-medium">Support 24/7</h4>
                            ...
                            <div class="group flex transition-all duration-500 ease-in-out xl:p-3">
                                ...
                                <div class="flex-1 md:order-1 order-2 ltr:md:text-right rtl:md:text-left ltr:md:mr-4 rtl:md:ml-4 ltr:md:ml-0 rtl:md:mr-0 ltr:ml-4 rtl:mr-4">
                                    <h4 class="mb-0 text-lg font-medium">7 Days Return</h4>
                                    <p class="text-slate-400 mt-3">One disadvantage of Lorum Ipsum is that in Latin frequently than others</p>
                                </div>
                            </div>
                            <!--end feature-->
                            ...
                            <div class="group flex transition-all duration-500 ease-in-out xl:p-3">
                                ...
                                <div class="flex-1 md:order-1 order-2 ltr:md:text-right rtl:md:text-left ltr:md:mr-4 rtl:md:ml-4 ltr:md:ml-0 rtl:md:mr-0 ltr:ml-4 rtl:mr-4">
                                    <h4 class="mb-0 text-lg font-medium">100% Payment Secure</h4>
                                    <p class="text-slate-400 mt-3">One disadvantage of Lorum Ipsum is that in Latin frequently than others</p>
                                </div>
                            </div>
                            <!--end feature-->
                    ...
                    <div class="lg:col-span-4 md:col-span-6 order-3">
                        <div class="grid grid-cols-1 gap-[30px]">
                            ...
                            <div class="group flex transition-all duration-500 ease-in-out xl:p-3">
                                ...
                                <div class="flex-1 ltr:ml-4 rtl:mr-4">
                                    <h4 class="mb-0 text-lg font-medium">Sports Modes</h4>
                                    <p class="text-slate-400 mt-3">One disadvantage of Lorum Ipsum is that in Latin frequently than others</p>
                                </div>
                            </div>
                            <!--end feature-->
                            ...
                            <div class="group flex transition-all duration-500 ease-in-out xl:p-3">
                                ...
                                <div class="flex-1 ltr:ml-4 rtl:mr-4">
                                    <h4 class="mb-0 text-lg font-medium">Games</h4>
                                    <p class="text-slate-400 mt-3">One disadvantage of Lorum Ipsum is that in Latin frequently than others</p>
                                </div>
                            </div>
                            <!--end feature-->
