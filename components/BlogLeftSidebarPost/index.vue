            ...
            <div class="grid md:grid-cols-12 grid-cols-1 gap-[30px]">
                <div class="lg:col-span-8 md:col-span-6 order-1 md:order-2">
                    <div class="p-6 rounded-md shadow dark:shadow-gray-800">
                        ...
                        <img src="@/assets/images/blog/03.jpg" class="rounded-md" alt="">
                        ...
                        <div class="text-center mt-12">
                            ...
                            <ul class="list-none mt-6">
                                ...
                                <li class="inline-block font-semibold text-slate-400 mx-4"> <span
                                        class="text-slate-900 dark:text-white block">Date :</span> <span class="block">23th
                                        May, 2022</span></li>
                                <li class="inline-block font-semibold text-slate-400 mx-4"> <span
                                        class="text-slate-900 dark:text-white block">Time :</span> <span class="block">8 Min
                                        Read</span></li>
                            </ul>
                        </div>
                        ...
                        <div class="mt-6">
                            ...
                            <p
                                class="text-slate-400 italic border-x-4 border-indigo-600 ltr:rounded-tl-xl rtl:rounded-tr-xl ltr:rounded-br-xl rtl:rounded-bl-xl mt-3 p-3">
                    ...
                    <div class="p-6 rounded-md shadow dark:shadow-gray-800 mt-8">
                        ...
                        <div class="mt-8">
                            <div class="flex items-center justify-between">
                                ...
                                <a href=""
                                    class="text-slate-400 hover:text-indigo-600 transition-all duration-500 ease-in-out ltr:ml-5 rtl:mr-5"><i
                                    ...
                                    <div class="ltr:text-left rtl:text-right">
                                        ...
                                        <div class="form-icon relative mt-2">
                                            ...
                                            <input name="email" id="email" type="email"
                                                class="form-input ltr:pl-11 rtl:pr-11" placeholder="Email :">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="ltr:text-left rtl:text-right">
                                        ...
                                        <div class="form-icon relative mt-2">
                                            ...
                                            <textarea name="comments" id="comments"
                                                class="form-input ltr:pl-11 rtl:pr-11 h-28"
                ...
                <div class="lg:col-span-4 md:col-span-6 order-2 md:order-1">
                    <div class="sticky top-20">
                        ...
                        <div class="text-center mt-8">
                            <img src="@/assets/images/client/05.jpg" class="h-24 w-24 mx-auto rounded-full shadow mb-4"
                                alt="">
                    ...
                    <div class="text-center subcribe-form">
                        <form class="relative mx-auto max-w-xl">
                            <input type="email" id="subemail" name="name"
                                class="pt-4 ltr:pr-40 rtl:pl-40 pb-4 ltr:pl-6 rtl:pr-6 w-full h-[50px] outline-none text-black dark:text-white rounded-full bg-white/70 dark:bg-slate-900/70 border border-gray-100 dark:border-gray-700"
                                placeholder="Enter your email id..">
                            <button type="submit"
                                class="btn absolute top-[2px] ltr:right-[3px] rtl:left-[3px] h-[46px] bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-full">Subcribe
                                Now</button>
                        </form><!--end form-->
                    </div>
                </div>
