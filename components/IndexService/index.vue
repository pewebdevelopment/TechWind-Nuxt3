<template>
      <!-- Start Hero -->
      <section class="relative table w-full pt-36 lg:pt-44 pb-32 bg-[url('../../assets/images/home-shape.png')] bg-top bg-no-repeat bg-cover">
            <div class="container">
                <div class="grid md:grid-cols-12 grid-cols-1 items-center mt-10 gap-[30px]">
                    <div class="md:col-span-7">
                        <div class="ltr:md:mr-6 rtl:md:ml-6">
                            <h4 class="font-semibold lg:leading-normal leading-normal text-4xl lg:text-5xl mb-5 text-black dark:text-white">Find the perfect <br> <span class="text-indigo-600">Professional</span> for you</h4>
                            ...
                            <div class="subcribe-form z-1 mt-8">
                                <form class="relative mx-auto max-w-2xl">
                                    <i data-feather="search" class="w-5 h-5 absolute top-[47%] -translate-y-1/2 ltr:left-4 rtl:right-4"></i>
                                    <input type="text" id="search_name" name="name" class="pt-4 ltr:pr-4 rtl:pl-40 pb-4 w-full h-[50px] outline-none text-black dark:text-white rounded-md bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 ltr:pl-12 rtl:pr-12" placeholder="What service are you looking for?">
                                    <button type="submit" class="btn absolute top-[2px] ltr:right-[3px] rtl:left-[3px] h-[46px] bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md">Search</button>
                                </form><!--end form-->
        ...
        <section class="relative md:pb-24 pb-16">
            <div class="container">
                ...
                <div class="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                    ...
                    <div class="group transition-all duration-500 ease-in-out text-center">
                        <div class="flex align-middle mx-auto justify-center items-center w-14 h-14 mt-1 bg-indigo-600/5 group-hover:bg-indigo-600 group-hover:text-white border-2 border-indigo-600/20 text-indigo-600 rounded-lg text-2xl shadow-sm dark:shadow-gray-800 transition-all duration-500 ease-in-out">
                            <i class="uil uil-arrow-growth"></i>
                        </div>
                        <div class="mt-4">
                            <a href="" class="text-xl font-medium hover:text-indigo-600 duration-500 ease-in-out">Business Service</a>
                            <p class="text-slate-400 mt-2">One advantage everything you need to generate</p>
                        </div>
                    </div>
                    <!-- Content -->
                    ...
                    <div class="group transition-all duration-500 ease-in-out text-center">
                        ...
                        <div class="mt-4">
                            <a href="" class="text-xl font-medium hover:text-indigo-600 duration-500 ease-in-out">Social Service</a>
                            <p class="text-slate-400 mt-2">One advantage everything you need to generate</p>
                        </div>
                    </div>
                    <!-- Content -->
                    ...
                    <div class="group transition-all duration-500 ease-in-out text-center">
                        ...
                        <div class="mt-4">
                            <a href="" class="text-xl font-medium hover:text-indigo-600 duration-500 ease-in-out">Personal Service</a>
                            <p class="text-slate-400 mt-2">One advantage everything you need to generate</p>
                        </div>
                    </div>
                    <!-- Content -->
                    ...
                    <div class="group transition-all duration-500 ease-in-out text-center">
                        ...
                        <div class="mt-4">
                            <a href="" class="text-xl font-medium hover:text-indigo-600 duration-500 ease-in-out">Banking Service</a>
                            <p class="text-slate-400 mt-2">One advantage everything you need to generate</p>
                        </div>
                    </div>
                    <!-- Content -->
                    ...
                    <div class="group transition-all duration-500 ease-in-out text-center">
                        ...
                        <div class="mt-4">
                            <a href="" class="text-xl font-medium hover:text-indigo-600 duration-500 ease-in-out">Insurance Service</a>
                            <p class="text-slate-400 mt-2">One advantage everything you need to generate</p>
                        </div>
                    </div>
                    <!-- Content -->
                    ...
                    <div class="group transition-all duration-500 ease-in-out text-center">
                        ...
                        <div class="mt-4">
                            <a href="" class="text-xl font-medium hover:text-indigo-600 duration-500 ease-in-out">Transportation Service</a>
                            <p class="text-slate-400 mt-2">One advantage everything you need to generate</p>
                        </div>
                    </div>
                    <!-- Content -->
                    ...
                    <div class="group transition-all duration-500 ease-in-out text-center">
                        ...
                        <div class="mt-4">
                            <a href="" class="text-xl font-medium hover:text-indigo-600 duration-500 ease-in-out">Warehousing Service</a>
                            <p class="text-slate-400 mt-2">One advantage everything you need to generate</p>
                        </div>
                    </div>
                    <!-- Content -->
                    ...
                    <div class="group transition-all duration-500 ease-in-out text-center">
                        ...
                        <div class="mt-4">
                            <a href="" class="text-xl font-medium hover:text-indigo-600 duration-500 ease-in-out">Communication Service</a>
                            <p class="text-slate-400 mt-2">One advantage everything you need to generate</p>
                        </div>
                    </div>
                    <!-- Content -->
            ...
            <div class="container md:mt-24 mt-16">
                <div class="grid grid-cols-1 pb-8 text-center">
                    <h3 class="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold text-black dark:text-white">What Our Client Say ?</h3>
                ...
                <div class="flex justify-center relative mt-16">
                    <div class="relative lg:w-1/3 md:w-1/2 w-full">
                        ...
                        <div class="tiny-single-item">
                            <div class="tiny-slide">
                                <div class="text-center">
                                    ...
                                    <div class="text-center mt-5">
                                        ...
                                        <img src="@/assets/images/client/01.jpg" class="h-14 w-14 rounded-full shadow-md dark:shadow-gray-800 mx-auto" alt="">
                            ...
                            <div class="tiny-slide">
                                <div class="text-center">
                                    ...
                                    <div class="text-center mt-5">
                                        ...
                                        <img src="@/assets/images/client/02.jpg" class="h-14 w-14 rounded-full shadow-md dark:shadow-gray-800 mx-auto" alt="">
                                        <h6 class="mt-2 font-semibold">Christa Smith</h6>
                                        <span class="text-slate-400 text-sm">Manager</span>
                                    </div>
                                </div>
                            ...
                            <div class="tiny-slide">
                                <div class="text-center">
                                    ...
                                    <div class="text-center mt-5">
                                        ...
                                        <img src="@/assets/images/client/03.jpg" class="h-14 w-14 rounded-full shadow-md dark:shadow-gray-800 mx-auto" alt="">
                                        <h6 class="mt-2 font-semibold">Christa Smith</h6>
                                        <span class="text-slate-400 text-sm">Manager</span>
                                    </div>
                                </div>
                            ...
                            <div class="tiny-slide">
                                <div class="text-center">
                                    ...
                                    <div class="text-center mt-5">
                                        ...
                                        <img src="@/assets/images/client/04.jpg" class="h-14 w-14 rounded-full shadow-md dark:shadow-gray-800 mx-auto" alt="">
                                        <h6 class="mt-2 font-semibold">Christa Smith</h6>
                                        <span class="text-slate-400 text-sm">Manager</span>
                                    </div>
                                </div>
                            ...
                            <div class="tiny-slide">
                                <div class="text-center">
                                    <p class="text-lg text-slate-400 italic"> " Techwind made selling my home easy and stress free. They went above and beyond what is expected. " </p>
                                    ...
                                    <div class="text-center mt-5">
                                        ...
                                        <img src="@/assets/images/client/05.jpg" class="h-14 w-14 rounded-full shadow-md dark:shadow-gray-800 mx-auto" alt="">
                                        <h6 class="mt-2 font-semibold">Christa Smith</h6>
                                        <span class="text-slate-400 text-sm">Manager</span>
                                    </div>
                                </div>
                            ...
                            <div class="tiny-slide">
                                <div class="text-center">
                                    <p class="text-lg text-slate-400 italic"> " Techwind is fair priced, quick to respond, and easy to use. I highly recommend their services! " </p>
                                    ...
                                    <div class="text-center mt-5">
                                        ...
                                        <img src="@/assets/images/client/06.jpg" class="h-14 w-14 rounded-full shadow-md dark:shadow-gray-800 mx-auto" alt="">
                                        <h6 class="mt-2 font-semibold">Christa Smith</h6>
                                        <span class="text-slate-400 text-sm">Manager</span>
                                    </div>
                                </div>
            ...
            <div class="container md:mt-24 mt-16">
                ...
                <div id="accordion-collapse" data-accordion="collapse" class="grid md:grid-cols-2 grid-cols-1 mt-8 md:gap-[30px]">
                    ...
                    <div>
                        <div class="relative shadow dark:shadow-gray-800 rounded-md overflow-hidden md:mt-0 mt-4">
            ...
            <div class="container md:mt-24 mt-16">
                <div class="grid grid-cols-1 text-center">
                    ...
                    <div class="mt-6">
                        <a href="contact-one.html" class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md"><i class="uil uil-phone align-middle ltr:mr-2 rtl:ml-2"></i> Contact us</a>
                    </div>
                </div><!--end grid-->
            </div><!--end container-->
        </section><!--end section-->
