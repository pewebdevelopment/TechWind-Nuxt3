<template>
        ...
        <section class="relative flex md:h-screen py-44 items-center bg-cover bg-center self-center">
            <div class="absolute inset-0 h-full w-full jarallax" data-jarallax data-speed="0.8" style="background: url('@/assets/images/photography/first.jpg') bottom;"></div>
            <div class="absolute inset-0 h-full w-full md:block hidden jarallax" data-jarallax data-speed="0.5" style="background: url('@/assets/images/photography/hero-text-lg.png') center;"></div>
            <div class="absolute inset-0 h-full w-full block md:hidden jarallax" data-jarallax data-speed="0.5" style="background: url('@/assets/images/photography/hero-text-sm.png') center;"></div>
            <div class="absolute inset-0 h-full w-full jarallax" data-jarallax data-speed="1.1" style="background: url('@/assets/images/photography/last.png') bottom;"></div>
            ...
            <div class="container">
                ...
                <div class="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                    <div class="relative overflow-hidden h-fit">
                        <img src="@/assets/images/photography/01.jpg" class="rounded-md" alt="">
                        ...
                        <div class="absolute text-center p-6 bottom-0 left-0 right-0">
                            <a href="photography-about.html" class="font-semibold text-lg">Jack Jeffrey <i class="uil uil-arrow-up-right"></i></a>
                        </div>
                    </div><!--end content-->

                    <div class="relative overflow-hidden h-fit lg:mt-16">
                        <img src="@/assets/images/photography/02.jpg" class="rounded-md" alt="">
                        <div class="absolute inset-0 h-full w-full bg-gradient-to-t to-transparent via-white/80 dark:via-slate-900/80 from-white dark:from-slate-900"></div>

                        <div class="absolute text-center p-6 bottom-0 left-0 right-0">
                            <a href="photography-portfolio.html" class="font-semibold text-lg">Portfolio <i class="uil uil-arrow-up-right"></i></a>
                        </div>
                    </div><!--end content-->

                    <div class="relative overflow-hidden h-fit">
                        <img src="@/assets/images/photography/03.jpg" class="rounded-md" alt="">
                        <div class="absolute inset-0 h-full w-full bg-gradient-to-t to-transparent via-white/80 dark:via-slate-900/80 from-white dark:from-slate-900"></div>

                        <div class="absolute text-center p-6 bottom-0 left-0 right-0">
                            <a href="contact-two.html" class="font-semibold text-lg">Contact <i class="uil uil-arrow-up-right"></i></a>
                        </div>
                    </div><!--end content-->

                    <div class="relative overflow-hidden h-fit lg:mt-16">
                        <img src="@/assets/images/photography/04.jpg" class="rounded-md" alt="">
                        <div class="absolute inset-0 h-full w-full bg-gradient-to-t to-transparent via-white/80 dark:via-slate-900/80 from-white dark:from-slate-900"></div>
                ...
                <div class="flex justify-center">
                    <div class="lg:max-w-768 w-full text-center">
                        ...
                        <div class="mt-6 text-center">
                            <a href="photography-about.html" class="btn btn-link text-slate-400 dark:text-white/70 dark:hover:text-white hover:text-indigo-600 after:bg-indigo-600 dark:after:bg-white duration-500 ease-in-out">Read More <i class="uil uil-arrow-right"></i></a>
                        </div>
                    </div>
                </div><!--end flex-->
            </div><!--end container-->
