<template>
        ...
        <!-- Start Hero -->
        <section class="relative table w-full py-36 pb-0 lg:py-44 lg:pb-0 bg-indigo-600 bg-[url('../../@/assets/images/bg2.png')] bg-center bg-no-repeat bg-cover">
            <div class="container">
                <div class="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                    <div class="lg:col-span-7">
                        <div class="ltr:md:mr-6 rtl:md:ml-6 md:mb-20">
                            ...
                            <div class="mt-6">
                                <a href="contact-one.html" class="btn bg-gray-50 hover:bg-gray-200 dark:bg-slate-900 dark:hover:bg-gray-700 hover:border-gray-100 dark:border-gray-700 dark:hover:border-gray-700 rounded-md ltr:mr-2 rtl:ml-2 mt-2"><i class="uil uil-envelope"></i> Get Started</a>
                            </div>
                        </div>
                    </div><!--end col-->
