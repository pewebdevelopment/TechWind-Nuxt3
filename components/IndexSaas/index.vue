<template>
        ...
        <section class="relative home-wrapper items-center overflow-hidden">
            <div class="container z-2">
                ...
                <div class="bg-indigo-600 w-8 h-16 z-2 absolute ltr:left-2 rtl:right-2 lg:bottom-28 md:bottom-36 sm:bottom-40 bottom-16"></div>
                <div class="bg-indigo-600/20 w-8 h-16 z-2 absolute ltr:left-12 rtl:right-12 lg:bottom-32 md:bottom-40 sm:bottom-44 bottom-20"></div>

                <div class="bg-indigo-600/20 w-8 h-16 z-2 absolute ltr:right-12 rtl:left-12 xl:bottom-[420px] lg:bottom-[315px] md:bottom-[285px] sm:bottom-80 bottom-32"></div>
                <div class="bg-indigo-600 w-8 h-16 z-2 absolute ltr:right-2 rtl:left-2 xl:bottom-[440px] lg:bottom-[335px] md:bottom-[305px] sm:bottom-[340px] bottom-36"></div>
            </div><!--end container-->
        </section><!--end section-->
        <!-- End Hero -->
        ...
        <section class="relative md:py-24 py-16 overflow-hidden">
            ...
            <div class="container md:mt-24 mt-16">
                <div class="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                    ...
                    <div class="ltr:lg:mr-8 rtl:lg:ml-8 order-2 md:order-1 wow animate__animated animate__fadeInLeft" data-wow-delay=".5s">
