<template>
        ...
        <section class="md:h-screen py-36 h-auto relative flex items-center background-effect overflow-hidden 
            ...
            <div class="container-fluid">
                <div class="absolute inset-0 jarallax" data-jarallax data-speed="0.5" style="background: url('@/assets/images/personal/hero-overlay.png') top center;"></div>
            </div>
                        ...
                        <div class="grid md:grid-cols-12 mt-12">
                            <div class="lg:col-span-4 md:col-span-6 order-2 lg:order-1 mt-6 md:mt-0 relative">
                                <div class="rounded-md lg:shadow-md lg:dark:shadow-gray-800 lg:absolute lg:top-14 lg:bg-white lg:dark:bg-slate-900 lg:p-6">
                                    <h5 class="mb-3 text-2xl font-bold lg:text-black lg:dark:text-white text-white">I'm Professional Web Developer</h5>
                                    ...
                                    <div class="mt-4">
                                        <a href="#portfolio" class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md">Hire me</a>
                                    </div>
                                </div>
                            </div>
                            <!--end col-->
                            ...
                            <div class="lg:col-span-4 md:col-span-6 order-1 lg:order-3">
                                <h4 class="lg:text-[64px] lg:leading-[1.1] text-[40px] font-bold lg:text-black lg:dark:text-white text-white mb-0">John <br> S<span class="typewrite" data-period="2000" data-type='[ "tradford!"]'></span></h4>
                            </div>
                            <!--end col-->
                        </div>
                        <!--end grid-->
                ...
                <div class="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                    <div class="lg:col-span-5 md:col-span-6">
                        <div class="relative">
                            ...
                            <div class="absolute top-0 ltr:left-0 rtl:right-0 -z-1">
        ...
        <section class="relative md:py-24 py-16 bg-gray-50 dark:bg-slate-800">
            <div class="container">
                ...
                <div class="grid grid-cols-1 mt-8">
                    <div class="relative after:content-[''] after:absolute after:top-0 ltr:md:after:right-0 ltr:md:after:left-0 rtl:md:after:left-0 rtl:md:after:right-0 after:w-px after:h-full md:after:m-auto ltr:after:border-l-2 rtl:after:border-r-2 after:border-dashed after:border-gray-200 dark:after:border-gray-700 ltr:ml-3 rtl:mr-3 ltr:md:ml-0 rtl:md:mr-0">
                        <!--Start content-->
                        <div class="ltr:ml-8 rtl:mr-8 ltr:md:ml-0 rtl:md:mr-0 relative after:content-[''] after:absolute after:top-[9px] after:rounded-full after:z-10 after:w-2.5 after:h-2.5 after:bg-indigo-600 md:after:mx-auto ltr:md:after:right-0 ltr:md:after:left-0 rtl:md:after:left-0 rtl:md:after:right-0 ltr:after:-left-9 rtl:after:-right-9 before:content-[''] before:absolute md:before:mx-auto ltr:md:before:right-0 ltr:md:before:left-0 ltr:before:-left-11 rtl:md:before:left-0 rtl:md:before:right-0 rtl:before:-right-11 before:rounded-full before:z-10 before:border-2 before:border-dashed before:border-gray-200 dark:before:border-gray-700 before:top-0 before:w-7 before:h-7 before:bg-white dark:before:bg-slate-900">
                            <div class="grid md:grid-cols-2">
                                <div class="ltr:md:text-right ltr:md:mr-8 rtl:md:text-left rtl:md:ml-8 relative">
                                    <img src="@/assets/images/client/shree-logo.png" class="rounded-full h-9 w-9 ltr:md:ml-auto rtl:md:mr-auto" alt="">
                                    <h5 class="my-2 font-semibold text-lg">Self Employed</h5>
                                    <h6 class="text-slate text-sm mb-0">2019-21</h6>
                                </div>

                                <div class="ltr:float-left rtl:float-right ltr:text-left rtl:text-right ltr:md:ml-8 rtl:md:mr-8 mt-6 md:mt-0">
                        ...
                        <!--Start content-->
                        <div class="mt-12 ltr:ml-8 rtl:mr-8 ltr:md:ml-0 rtl:md:mr-0 relative after:content-[''] after:absolute after:top-[9px] after:rounded-full after:z-10 after:w-2.5 after:h-2.5 after:bg-indigo-600 md:after:mx-auto ltr:md:after:right-0 ltr:md:after:left-0 ltr:after:-left-9 rtl:md:after:left-0 rtl:md:after:right-0 rtl:after:-right-9 before:content-[''] before:absolute md:before:mx-auto ltr:md:before:right-0 ltr:md:before:left-0 ltr:before:-left-11 rtl:md:before:left-0 rtl:md:before:right-0 rtl:before:-right-11 before:rounded-full before:z-10 before:border-2 before:border-dashed before:border-gray-200 dark:before:border-gray-700 before:top-0 before:w-7 before:h-7 before:bg-white dark:before:bg-slate-900">
                            <div class="grid md:grid-cols-2">
                                <div class="ltr:text-left rtl:text-right ltr:md:ml-8 rtl:md:mr-8 relative md:order-2">
                                    <img src="@/assets/images/client/google-logo.png" class="rounded-full h-9 w-9 ltr:md:mr-auto rtl:md:ml-auto" alt="">
                                    <h5 class="my-2 font-semibold text-lg">Google Tech.</h5>
                                    <h6 class="text-slate text-sm mb-0">2018-19</h6>
                                </div>

                                <div class="ltr:float-left rtl:float-right ltr:md:text-right rtl:md:text-left ltr:md:mr-8 rtl:md:ml-8 mt-6 md:mt-0 md:order-1">
                        ...
                        <div class="mt-12 ltr:ml-8 rtl:mr-8 ltr:md:ml-0 rtl:md:mr-0 relative after:content-[''] after:absolute after:top-[9px] after:rounded-full after:z-10 after:w-2.5 after:h-2.5 after:bg-indigo-600 md:after:mx-auto ltr:md:after:right-0 ltr:md:after:left-0 ltr:after:-left-9 rtl:md:after:left-0 rtl:md:after:right-0 rtl:after:-right-9 before:content-[''] before:absolute md:before:mx-auto ltr:md:before:right-0 ltr:md:before:left-0 ltr:before:-left-11 rtl:md:before:left-0 rtl:md:before:right-0 rtl:before:-right-11 before:rounded-full before:z-10 before:border-2 before:border-dashed before:border-gray-200 dark:before:border-gray-700 before:top-0 before:w-7 before:h-7 before:bg-white dark:before:bg-slate-900">
                            <div class="grid md:grid-cols-2">
                                <div class="ltr:md:text-right ltr:md:mr-8 rtl:md:text-left rtl:md:ml-8 relative">
                                    <img src="@/assets/images/client/lenovo-logo.png" class="rounded-full h-9 w-9 ltr:md:ml-auto rtl:md:mr-auto" alt="">
                        ...
                        <div class="mt-12 ltr:ml-8 rtl:mr-8 ltr:md:ml-0 rtl:md:mr-0 relative after:content-[''] after:absolute after:top-[9px] after:rounded-full after:z-10 after:w-2.5 after:h-2.5 after:bg-indigo-600 md:after:mx-auto ltr:md:after:right-0 ltr:md:after:left-0 ltr:after:-left-9 rtl:md:after:left-0 rtl:md:after:right-0 rtl:after:-right-9 before:content-[''] before:absolute md:before:mx-auto ltr:md:before:right-0 ltr:md:before:left-0 ltr:before:-left-11 rtl:md:before:left-0 rtl:md:before:right-0 rtl:before:-right-11 before:rounded-full before:z-10 before:border-2 before:border-dashed before:border-gray-200 dark:before:border-gray-700 before:top-0 before:w-7 before:h-7 before:bg-white dark:before:bg-slate-900">
                            <div class="grid md:grid-cols-2">
                                <div class="ltr:text-left rtl:text-right ltr:md:ml-8 rtl:md:mr-8 relative md:order-2">
                                    <img src="@/assets/images/client/circle-logo.png" class="rounded-full h-9 w-9 ltr:md:mr-auto rtl:md:ml-auto" alt="">
            ...
            <div class="container relative">
                <div class="grid grid-cols-1 pb-8 text-center">
                    ...
                    <div class="relative mt-8">
                        <a href="" class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md">Hire Me</a>
                    </div>
                </div><!--end grid-->
            </div><!--end container-->
        </section><!--end section-->
        ...
        <section class="relative md:py-24 py-16" id="portfolio">
            ...
            <div class="container md:mt-24 mt-16">
                <div class="grid grid-cols-1 text-center">
                    <h6 class="text-indigo-600 text-sm font-bold uppercase mb-2">Contact Me</h6>
