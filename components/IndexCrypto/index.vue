<template>
    ...
    <section class="relative table w-full py-52 md:py-64 bg-[url('../../@/assets/images/crypto/bg1.jpg')] bg-center bg-no-repeat bg-cover">
                ...
                <div class="grid grid-cols-1">
                    ...
                    <div class="subcribe-form mt-6 mb-4">
                        <form class="relative max-w-xl">
                            <input type="email" id="subcribe" name="email" class="pt-4 ltr:pr-40 rtl:pl-40 pb-4 ltr:pl-6 rtl:pr-6 w-full h-[50px] outline-none dark:text-white rounded-full bg-white/5 shadow border border-slate-900 text-white" placeholder="Your Email Address :">
                            <button type="submit" class="btn absolute top-[2px] ltr:right-[3px] rtl:left-[3px] h-[46px] bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-full">Register Now <i class="uil uil-arrow-right"></i></button>
                        </form><!--end form-->
                    </div>
        ...
        <div class="relative">
            <div class="shape absolute right-0 sm:-bottom-px -bottom-[2px] left-0 overflow-hidden">
                <div class="container">
                    <div class="grid grid-cols-1">
            ...
            <div class="container">
                <div class="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                    ...
                    <div class="lg:col-span-7 mt-8 md:mt-0">
                        <div class="ltr:lg:ml-10 rtl:lg:mr-10">
                    ...
                    <div class="lg:col-span-5 md:col-span-6 order-2 md:order-1">
                        <div class="shadow dark:shadow-gray-800 rounded-md p-6 bg-gray-50 dark:bg-slate-800 overflow-hidden">
                            ...
                            <ul class="list-none mt-4">
                                <li class="mb-1 flex"><i class="uil uil-check-circle text-indigo-600 text-xl ltr:mr-2 rtl:ml-2"></i> <span class="text-slate-400">Soft Cap:</span> &nbsp;10000 USD</li>
                                <li class="mb-1 flex"><i class="uil uil-check-circle text-indigo-600 text-xl ltr:mr-2 rtl:ml-2"></i> <span class="text-slate-400">Min. transaction Amount:</span> &nbsp;1000 USD</li>
                                <li class="mb-1 flex"><i class="uil uil-check-circle text-indigo-600 text-xl ltr:mr-2 rtl:ml-2"></i> <span class="text-slate-400">Target:</span> &nbsp;900000 USD</li>
                            </ul>
                    ...
                    <div class="lg:col-span-7 md:col-span-6 order-1 md:order-2">
                        <div class="ltr:lg:ml-10 rtl:lg:mr-10">
                            ...
                            <div class="mt-4">
                                ...
                                <a href="#!" data-type="youtube" data-id="yba7hPeTSjk" class="btn btn-icon rounded-full bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white m-1 lightbox"><i data-feather="video" class="h-4 w-4"></i></a><span class="font-semibold ltr:ml-1 rtl:mr-1 align-middle">Watch Now</span>
                            </div>
                        </div>
                    </div>
                </div><!--end grid-->
