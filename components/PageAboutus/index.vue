                    ...
                    <div class="lg:col-span-7 md:col-span-6">
                        <div class="ltr:lg:ml-5 rtl:lg:mr-5">
                            <div class="flex mb-4">
                                ...
                                <span class="self-end font-medium ltr:ml-2 rtl:mr-2">Years <br> Experience</span>
                            </div>
            ...
            <div class="container md:mt-24 mt-16">
                <div class="grid md:grid-cols-12 grid-cols-1 items-center">
                    <div class="lg:col-span-5 md:col-span-6 md:order-1 order-2">
                        <div class="relative overflow-hidden after:content-[''] after:absolute after:h-40 after:w-40 after:bg-red-600/5 after:top-5 ltr:after:left-0 rtl:after:right-0 ltr:after:right-0 rtl:after:left-0 after:mx-auto after:-z-0 after:rounded-3xl after:animate-[spin_10s_linear_infinite]">
