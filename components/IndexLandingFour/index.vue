<template>
        ...
        <!-- Start Hero -->
        <section class="relative table w-full py-36 lg:py-44 bg-gray-50 dark:bg-slate-800 bg-[url('../../assets/images/bg4.png')] bg-bottom bg-cover" id="home">
            <div class="container">
                <div class="grid lg:grid-cols-12 md:grid-cols-2 mt-10 items-center gap-[30px]">
                    <div class="lg:col-span-7">
                        ...
                        <div class="relative mt-10">
                            <a href="" class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-full ltr:mr-1 rtl:ml-1">Get Started</a>
                            <a href="#!" data-type="youtube" data-id="yba7hPeTSjk" class="btn btn-icon btn-lg bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-full lightbox"><i class="mdi mdi-play text-xl align-middle"></i></a><small class="text-sm uppercase align-middle font-bold ltr:ml-2 rtl:mr-2">Watch Now</small>
                        </div>
                    </div>

                    <div class="lg:col-span-5">
                        <div class="bg-white dark:bg-slate-900 rounded-xl shadow dark:shadow-gray-800 md:p-8 p-6 ltr:lg:ml-10 rtl:lg:mr-10 z-10 relative">
                                ...
                                <div class="grid grid-cols-1">
                                    <div class="mb-5">
                                        ...
                                        <div class="form-icon relative mt-2">
                                            ...
                                            <input type="text" class="form-input ltr:pl-12 rtl:pr-12" placeholder="Name" name="name" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <div class="form-icon relative mt-2">
                                            ...
                                            <input type="email" class="form-input ltr:pl-12 rtl:pr-12" placeholder="Email" name="email" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <div class="form-icon relative mt-2">
                                            ...
                                            <input name="number" id="phNumber" class="form-input ltr:pl-12 rtl:pr-12" placeholder="+12 12458 854" required>
                                        </div>
                                    </div>
