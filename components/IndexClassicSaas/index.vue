        ...
        <div class="container">
            <div class="relative grid md:grid-cols-12 grid-cols-1 items-center mt-10 gap-[30px]">
                <div class="md:col-span-7">
                    <div class="ltr:md:mr-6 rtl:md:ml-6">
                        <h4
                            ...
                            Fast and clean help <br> <span
                                class="after:absolute ltr:after:right-0 rtl:after:left-0 ltr:after:left-0 rtl:after:right-0 after:bottom-3 after:lg:h-3 after:h-2 after:w-auto after:rounded-md after:bg-indigo-600/30 relative text-indigo-600">Structure</span>
                            your work</h4>
                        ...
                        <div class="relative mt-8">
                            <a href=""
                                class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md ltr:mr-2 rtl:ml-2">Get
                                Started</a>
                            <a href="#!" data-type="youtube" data-id="yba7hPeTSjk"
                                class="btn btn-icon bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-full lightbox"><i
                                    class="mdi mdi-play text-xl align-middle"></i></a><small
                                class="text-sm font-semibold uppercase align-middle ltr:ml-2 rtl:mr-2">Watch Now</small>
                        </div>
                    </div>
                </div><!--end col-->
                ...
                <div class="md:col-span-5">
                    <div
                        class="relative after:content-[''] after:absolute after:md:bottom-12 after:-bottom-20 ltr:after:lg:-left-0 ltr:after:md:-left-20 ltr:after:-left-24 rtl:after:lg:-right-0 rtl:after:md:-right-20 rtl:after:-right-24 after:bg-indigo-600 after:shadow-2xl after:shadow-indigo-600/40 after:-z-1 ltr:after:rotate-[130deg] rtl:after:-rotate-[130deg] after:w-[75rem] after:md:h-[55rem] after:h-[30rem] after:rounded-[20rem]">
                        <img src="@/assets/images/laptop.png" class="lg:max-w-none md:max-w-md" alt="">
                    </div>
                </div><!--end col-->

                <div
                    class="overflow-hidden after:content-[''] after:absolute after:h-32 after:w-32 after:bg-indigo-600/5 after:top-16 ltr:after:left-0 rtl:after:right-0  after:-z-1 after:rounded-3xl after:animate-[spin_10s_linear_infinite]">
                </div>
            </div><!--end grid-->
        </div><!--end container-->
    </section><!--end section-->
            ...
            <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-4 gap-[30px]">
                ...
                <div
                    ...
                    <div class="relative overflow-hidden text-transparent -m-3">
                        ...
                        <div
                            class="absolute top-2/4 -translate-y-2/4 left-0 right-0 mx-auto text-indigo-600 rounded-xl transition duration-500 ease-in-out text-3xl flex align-middle justify-center items-center">
                            <i class="uil uil-adjust-circle"></i>
                        </div>
                    </div>

                    <div class="mt-6">
                        <a href="" class="text-xl font-medium hover:text-indigo-600 duration-500 ease-in-out">Grow Your
                            Business</a>
                        <p class="text-slate-400 transition duration-500 ease-in-out mt-3">If the distribution of letters
                            and 'words' is random, the reader will not be distracted from making.</p>
                    </div>
                </div>
                <!-- Content -->
                ...
                <div
                    ...
                    <div class="mt-6">
                        <a href="" class="text-xl font-medium hover:text-indigo-600 duration-500 ease-in-out">Drive More
                            Sales</a>
                        <p class="text-slate-400 transition duration-500 ease-in-out mt-3">If the distribution of letters
                            and 'words' is random, the reader will not be distracted from making.</p>
                    </div>
                ...
                <div
                    ...
                    <div class="mt-6">
                        <a href="" class="text-xl font-medium hover:text-indigo-600 duration-500 ease-in-out">Handled By
                            Expert</a>
                        <p class="text-slate-400 transition duration-500 ease-in-out mt-3">If the distribution of letters
                            and 'words' is random, the reader will not be distracted from making.</p>
                    </div>
        ...
        <div class="container md:mt-24 mt-16">
            <div class="grid md:grid-cols-2 grid-cols-1 items-center mt-16 gap-[30px]">
                <div class="relative">
                    ...
                    <div
                        class="absolute -bottom-10 right-0 p-6 rounded-lg shadow-md dark:shadow-gray-800 bg-white dark:bg-slate-900 md:w-80 w-60">
                ...
                <div class="ltr:lg:ml-8 rtl:lg:mr-8 mt-8 md:mt-0">
                    <h4 class="mb-4 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">Manage all your
                        tasks <br> on this one plateform</h4>
            ...
            <div class="grid md:grid-cols-2 grid-cols-1 items-center gap-[30px]">
                ...
                <div class="ltr:lg:mr-8 rtl:lg:ml-8 order-2 md:order-1">
                    ...
                    <ul class="list-none text-slate-400 mt-4">
                        <li class="mb-1 flex"><i class="uil uil-check-circle text-indigo-600 text-xl ltr:mr-2 rtl:ml-2"></i>
                                ...
                                <div class="grid md:grid-cols-2 grid-cols-1 items-center">
                                    ...
                                    <div class="section-title text-md-start">
                                        ...
                                        <h3
                                            ...
                                            Get An Easy Start <br> With Techwind Now</h3>
                                    </div>
                                </div>

                                <div class="mt-8">
                                    <div class="section-title text-md-start">
                                        <p class="text-white/50 max-w-xl mx-auto mb-2">Start working with Techwind that
